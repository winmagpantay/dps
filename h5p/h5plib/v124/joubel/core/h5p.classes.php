...
class H5PContentValidator {
   ...
   *
   * Based on kses by Ulf Harnhammar, see https://sourceforge.net/projects/kses.
   * For examples of various XSS attacks, see: https://ha.ckers.org/xss.html.
   *
      ...
      $semantics = (object) array(
        ...
        'fields' => array(
          ...
          (object) array(
            ...
            'type' => 'text',
            'label' => $this->h5pF->t('Source'),
            'placeholder' => 'https://en.wikipedia.org/wiki/Mona_Lisa',
            'optional' => true,
            'regexp' => (object) array(
              'pattern' => '^http[s]?://.+',
              'modifiers' => 'i'
