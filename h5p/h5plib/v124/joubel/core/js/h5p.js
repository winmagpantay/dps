...
H5P.trim = function (value) {
  ...
  // I'm leaning towards implementing the missing ones: https://kangax.github.io/compat-table/es5/
  ...
  $(document).ready(function () {
    ...
    H5P.copyrightLicenses = {
      ...
      'GNU GPL': {
        ...
        link: 'https://www.gnu.org/licenses/gpl-:version-standalone.html',
        linkVersions: {
          'v3': '3.0',
          'v2': '2.0',
          'v1': '1.0'
      ...
      'ODC PDDL': '<a href="https://opendatacommons.org/licenses/pddl/1.0/" target="_blank">Public Domain Dedication and Licence</a>',
      'CC PDM': {
        label: H5P.t('licensePDM'),
        link: 'https://creativecommons.org/publicdomain/mark/1.0/'
      },
