 ...
 *   {@link https://adlnet.gov/expapi/verbs/|ADL xAPI Vocabulary}
 *
 */
 ...
 *
 * @param {boolean} full
 *   if true the full verb id prefixed by https://adlnet.gov/expapi/verbs/
 *   will be returned
 * @returns {string}
...
H5P.XAPIEvent.prototype.setObject = function (instance) {
  if (instance.contentId) {
    this.data.statement.object = {
      ...
      'definition': {
        'extensions': {
          'https://h5p.org/x-api/h5p-local-content-id': instance.contentId
        }
      }
    };
    if (instance.subContentId) {
      this.data.statement.object.definition.extensions['https://h5p.org/x-api/h5p-subContentId'] = instance.subContentId;
...
H5P.XAPIEvent.prototype.setContext = function (instance) {
  ...
  if (instance.libraryInfo) {
    ...
    this.data.statement.context.contextActivities.category = [
      {
        "id": "https://h5p.org/libraries/" + instance.libraryInfo.versionedNameNoSpaces,
        "objectType": "Activity"
      }
    ];
  }
...
/**
 * List of verbs defined at {@link https://adlnet.gov/expapi/verbs/|ADL xAPI Vocabulary}
 *
 * @type Array
 */
