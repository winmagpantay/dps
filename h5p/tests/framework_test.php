...
class framework_test extends \advanced_testcase {
    ...
    public function test_setLibraryTutorialUrl() {
        ...
        $lib1 = $generator->create_library_record('Library1', 'Lib1', 1, 0, 1, '', null, 'https://tutorial1.org',
            'https://example.org');
        $lib2 = $generator->create_library_record('Library2', 'Lib2', 2, 0, 1, '', null, 'https://tutorial2.org');
        ...
        $this->assertCount(3, $libraries);
        $this->assertNull($libraries[$lib1->id]->tutorial);
        $this->assertEquals($libraries[$lib2->id]->tutorial, 'https://tutorial2.org');
