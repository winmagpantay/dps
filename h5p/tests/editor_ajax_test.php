...
class editor_ajax_test extends \advanced_testcase {
    ...
    public function test_getContentTypeCache(): void {
        ...
        // Create several libraries records.
        $lib1 = $h5pgenerator->create_library_record('Library1', 'Lib1', 1, 0, 1, '', null, 'https://tutorial.org',
            'https://example.org');
        $lib2 = $h5pgenerator->create_library_record('Library2', 'Lib2', 2, 0, 1, '', null, 'https://tutorial.org');
