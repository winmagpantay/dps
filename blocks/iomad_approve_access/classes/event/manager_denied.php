...
/**
 * The block_iomad_approve_access manager denied event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class manager_denied extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('manager_denied', 'block_iomad_approve_access');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' denied access to user id '$this->relateduserid' for trainingevent id '$this->objectid' in course id " .
            $this->courseid;
    }
