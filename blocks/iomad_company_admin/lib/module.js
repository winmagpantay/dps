...
M.core_user.init_user_selector = function (Y, name, hash, extrafields, lastsearch) {
    ...
    var user_selector = {
        ...
        send_query : function(forceresearch) {
            ...
            var iotrans = Y.io(M.cfg.wwwroot + '/blocks/iomad_company_admin/lib/search.php', {
                method: 'POST',
                data: 'selectorid=' + hash + '&sesskey=' + M.cfg.sesskey + '&search=' + value + '&profilefieldid=' + vl + '&userselector_searchanywhere=' + this.get_option('searchanywhere'),
                on: {
