 ...
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class courses_notifyperiod_editable extends \core\output\inplace_editable {
    ...
    public function __construct($company, $context, $course, $currentvalue) {
        ...
        parent::__construct('block_iomad_company_admin', 'courses_notifyperiod', $itemid, $editable, $value, $value);
    ...
    public static function update($itemid, $newvalue) {
        ...
        $notifyperiod = json_decode($newvalue);
        $notifyperiod = clean_param($notifyperiod, PARAM_INT);
        if ($ntifyperiod < 0) {
            $notifyperiod = 0;
        }
        ...
        return new self($company, $context, $courserec, $notifyperiod);
    }
}
