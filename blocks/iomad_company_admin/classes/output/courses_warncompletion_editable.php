 ...
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class courses_warncompletion_editable extends \core\output\inplace_editable {
    ...
    public static function update($itemid, $newvalue) {
        ...
        // Process changes.
        $DB->set_field('iomad_courses', 'warncompletion', $warncompletion, ['courseid' => $courseid]);
        ...
        return new self($company, $context, $courserec, $warncompletion);
    }
}
