...
/**
 * The block_iomad_company_admin company user suspended event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_user_suspended extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companyusersuspended', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' was suspended in the company " . $this->other['companyname'];
    }
