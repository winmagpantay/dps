...
/**
 * The block_iomad_company_admin company terminated event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_terminated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companyterminated', 'block_iomad_company_admin');
    }
