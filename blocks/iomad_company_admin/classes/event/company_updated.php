...
/**
 * The block_iomad_company_admin company updated event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companyupdated', 'block_iomad_company_admin');
    }
