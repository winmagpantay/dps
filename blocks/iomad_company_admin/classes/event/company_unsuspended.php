...
/**
 * The block_iomad_company_admin company unsuspended event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_unsuspended extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companyunsuspended', 'block_iomad_company_admin');
    }
