...
/**
 * The block_iomad_company_admin company user used event.
 *
...
/**
 * The block_iomad_company_admin user license used event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_license_used extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('userlicenseused', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' used a license from license id'" . s($this->other['licenseid']) . "' to course id " .
            $this->courseid;
    }
