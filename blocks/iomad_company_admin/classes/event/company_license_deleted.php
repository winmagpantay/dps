...
/**
 * The block_iomad_company_admin company license deleted event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class company_license_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('companylicensedeleted', 'block_iomad_company_admin');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted license id'" . s($this->other['licenseid']);
    }
