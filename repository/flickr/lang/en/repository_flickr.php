...
<li>Visit <a href="https://www.flickr.com/services/api/keys/">Flickr API Keys</a> again.</li>
<li>Make sure you set the callback URL for this Flickr key as <strong>{$a}</strong></li></ol>';
$string['callbackwarning'] = '<ol>
<li>Get a <a href="https://www.flickr.com/services/api/keys/">Flickr API Key and Secret</a> from Flickr for this Moodle site.</li>
...
<li>Edit your <a href="https://www.flickr.com/services/api/keys/">Flickr</a> key details again and set the callback URL.</li></ol>';
