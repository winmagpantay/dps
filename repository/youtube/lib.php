 ...
 * @copyright  2010 Dongsheng Cai {@link https://dongsheng.org}
 ...
 * @since Moodle 2.0
 * @package    repository_youtube
 * @copyright  2009 Dongsheng Cai {@link https://dongsheng.org}
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
    ...
    private function _get_collection($keyword, $start, $max, $sort) {
        ...
        try {
            ...
            foreach ($response['items'] as $result) {
                ...
                $source = 'https://www.youtube.com/v/' . $result->id->videoId . '#' . $title;
