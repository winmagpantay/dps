...
XML;
    ...
    public function test_create_system_dav() {
        ...
        // Use `atLeastOnce` instead of `exactly(2)` because it is only called a second time on dev systems that allow https://.
        ...
        try {
            ...
            $endpoint->url = 'https://www.default.test/webdav/index.php';
