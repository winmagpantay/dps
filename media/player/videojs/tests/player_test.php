...
class player_test extends \advanced_testcase {
    ...
    public function test_embed_url() {
        ...
        $url = new moodle_url('https://example.org/1.webm');
    ...
    public function test_embed_link() {
        global $CFG;
        $url = new moodle_url('https://example.org/some_filename.mp4');
    ...
    public function test_fallback() {
        ...
        $urls = [
            new moodle_url('https://example.org/1.rv'), // Not supported.
            new moodle_url('https://example.org/2.webm'), // Supported.
            new moodle_url('https://example.org/3.ogv'), // Supported.
        ];
        ...
        $this->assertDoesNotMatchRegularExpression('~<source src="https://example.org/1.rv"~', $content);
        $this->assertMatchesRegularExpression('~<source src="https://example.org/2.webm"~', $content);
        $this->assertMatchesRegularExpression('~<source src="https://example.org/3.ogv"~', $content);
        // Links to all files are included.
        $this->assertMatchesRegularExpression(
            '~<a class="mediafallbacklink" href="https://example.org/1.rv">1.rv</a>~', $content);
        $this->assertMatchesRegularExpression(
            '~<a class="mediafallbacklink" href="https://example.org/2.webm">2.webm</a>~', $content);
        $this->assertMatchesRegularExpression(
            '~<a class="mediafallbacklink" href="https://example.org/3.ogv">3.ogv</a>~', $content);
    }
    ...
    public function test_prevent_other_players() {
        ...
        $url = new moodle_url('https://example.org/some_filename.webm');
        ...
        $this->assertMatchesRegularExpression(
            '~<a class="mediafallbacklink" href="https://example.org/some_filename.webm">Apply one player only</a>~', $content);
    }
    ...
    public function test_embed_media() {
        global $CFG;
        $url = new moodle_url('https://example.org/some_filename.mp4');
        $trackurl = new moodle_url('https://example.org/some_filename.vtt');
        ...
        // Audio tag.
        $url = new moodle_url('https://example.org/some_filename.mp3');
        $trackurl = new moodle_url('https://example.org/some_filename.vtt');
    ...
    public function test_youtube() {
        ...
        // Format: youtube.
        $url = new moodle_url('https://www.youtube.com/watch?v=vyrwMmsufJc');
        $t = $manager->embed_url($url);
        $this->youtube_plugin_engaged($t);
        $url = new moodle_url('https://www.youtube.com/v/vyrwMmsufJc');
        $t = $manager->embed_url($url);
        $this->youtube_plugin_engaged($t);
        ...
        $url = new moodle_url('https://www.youtube.com/view_play_list?p=PL6E18E2927047B662');
        $t = $manager->embed_url($url);
        $this->assertStringNotContainsString('mediaplugin_videojs', $t);
        $url = new moodle_url('https://www.youtube.com/playlist?list=PL6E18E2927047B662');
        $t = $manager->embed_url($url);
        $this->assertStringNotContainsString('mediaplugin_videojs', $t);
        $url = new moodle_url('https://www.youtube.com/p/PL6E18E2927047B662');
        $t = $manager->embed_url($url);
        $this->assertStringNotContainsString('mediaplugin_videojs', $t);
    }
    ...
    public function test_flash_behaviour() {
        ...
        $url = new moodle_url('https://example.org/some_filename.flv');
        $t = $manager->embed_url($url);
        $this->assertStringNotContainsString('mediaplugin_videojs', $t);
        $this->assertMatchesRegularExpression(
            '~<a class="mediafallbacklink" href="https://example.org/some_filename.flv">some_filename.flv</a>~', $t);
    }
