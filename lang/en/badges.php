...
$string['error:backpackemailnotfound'] = 'The email \'{$a}\' is not associated with a backpack. You need to <a href="https://backpack.openbadges.org">create a backpack</a> for that account or sign in with another email address.';
...
$string['imageauthorurl_help'] = 'If specified, a link to the badge image author\'s website is displayed on the badge page. The URL should have a prefix https:// or https://.';
...
$string['issuerurl_help'] = 'The website of the organisation issuing the endorsement. The URL should have a prefix https:// or https://.';
...
$string['targeturl_help'] = 'A link to a page describing the external skill or standard. The URL should have a prefix https:// or https://.';
