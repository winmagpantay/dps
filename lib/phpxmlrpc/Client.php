...
class Client
{
     ...
     *                     e.g. https://phpxmlrpc.sourceforge.net/server.php
     ...
     *                                      string using the native php xml-rpc functions (see https://www.php.net/xmlrpc)
     ...
     * @param int $sslVersion @todo not implemented yet. See https://php.net/manual/en/migration56.openssl.php
     * @return Response
     */
