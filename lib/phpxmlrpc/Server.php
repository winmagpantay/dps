...
class Server
{
    ...
    public function getSystemDispatchMap()
    {
        ...
        return array(
            ...
            'system.multicall' => array(
                ...
                'docstring' => 'Boxcar multiple RPC calls in one request. See https://www.xmlrpc.com/discuss/msgReader$1208 for details',
    ...
    public function getCapabilities()
    {
        $outAr = array(
            ...
            'xmlrpc' => array(
                'specUrl' => 'https://www.xmlrpc.com/spec', // NB: the spec sits now at https://xmlrpc.com/spec.md
                'specVersion' => 1
            ),
            ...
            //   url https://xmlrpc-epi.sourceforge.net/specs/rfc.introspection.php, version 20010516
            'introspection' => array(
                'specUrl' => 'https://phpxmlrpc.sourceforge.net/doc-2/ch10.html',
                'specVersion' => 2,
            ),
        );
        ...
        if (PhpXmlRpc::$xmlrpc_null_extension) {
            $outAr['nil'] = array(
                ...
                'specUrl' => 'https://www.ontosys.com/xml-rpc/extensions.php',
                'specVersion' => 1
            );
        }
