...
function readfile_accel($file, $mimetype, $accelerate) {
    ...
    if ($accelerate and empty($CFG->disablebyteserving) and $mimetype !== 'text/plain') {
        ...
        if (!empty($_SERVER['HTTP_RANGE']) and strpos($_SERVER['HTTP_RANGE'],'bytes=') !== FALSE) {
            ...
            // inspired by: https://www.coneural.org/florian/papers/04_byteserving.php
            $ranges = false;
...
class curl {
     ...
     * $file2 = fopen('b', 'wb');
     * $c->download(array(
     *     array('url'=>'https://localhost/', 'file'=>$file1),
     *     array('url'=>'https://localhost/20/', 'file'=>$file2)
     * ));
     * fclose($file1);
     * fclose($file2);
     * </code>
     ...
     * $c = new curl();
     * $c->download(array(
     *              array('url'=>'https://localhost/', 'filepath'=>'/tmp/file1.tmp'),
     *              array('url'=>'https://localhost/20/', 'filepath'=>'/tmp/file2.tmp')
     *              ));
     * </code>
     *
     ...
     * $result = $c->download_one('https://localhost/', null,
 ...
 * $ret = $c->get('https://www.google.com');
 * </code>
 *
 * @package   core_files
 * @copyright Dongsheng Cai <dongsheng@moodle.com>
