...
class webdav_client {
    ...
    function copy_file($src_path, $dst_path, $overwrite) {
        ...
        $this->header_add(sprintf('Destination: https://%s%s', $this->_server, $this->translate_uri($dst_path)));
        if ($overwrite) {
...
<executable xmlns="https://apache.org/dav/props/"/>
...
EOD;
    ...
    private function process_respond() {
        ...
        // First line should be a HTTP status line (see https://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html#sec6)
        ...
        // See https://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html#sec6
