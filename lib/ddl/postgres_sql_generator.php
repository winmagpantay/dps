...
class postgres_sql_generator extends sql_generator {
    ...
    public function getResetSequenceSQL($table) {
        ...
        // From https://www.postgresql.org/docs/7.4/static/sql-altersequence.html
    ...
    public function getTypeSQL($xmldb_type, $xmldb_length=null, $xmldb_decimals=null) {
        ...
        switch ($xmldb_type) {
            case XMLDB_TYPE_INTEGER:    // From https://www.postgresql.org/docs/7.4/interactive/datatype.html
