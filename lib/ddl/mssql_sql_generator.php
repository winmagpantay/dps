 ...
 *             2001-3001 Eloy Lafuente (stronk7) https://contiento.com
...
class mssql_sql_generator extends sql_generator {
    ...
    public function getResetSequenceSQL($table) {
        ...
        //     https://www.justinneff.com/archive/tag/dbcc-checkident
        if ($value == 0) {
        ...
        // From https://msdn.microsoft.com/en-us/library/ms176057.aspx
    ...
    public function getTypeSQL($xmldb_type, $xmldb_length=null, $xmldb_decimals=null) {
        ...
        switch ($xmldb_type) {
            case XMLDB_TYPE_INTEGER:    // From https://msdn.microsoft.com/library/en-us/tsqlref/ts_da-db_7msw.asp?frame=true
    ...
    public function getAlterFieldSQL($xmldb_table, $xmldb_field, $skip_type_clause = NULL, $skip_default_clause = NULL, $skip_notnull_clause = NULL) {
        ...
        // Here it is the matrix: https://msdn.microsoft.com/en-us/library/ms187928(SQL.90).aspx
    ...
    public static function getReservedWords() {
        ...
        // from https://msdn2.microsoft.com/en-us/library/ms189822.aspx
