...
class mysql_sql_generator extends sql_generator {
    ...
    public function getResetSequenceSQL($table) {
        ...
        // From https://dev.mysql.com/doc/refman/5.0/en/alter-table.html
    ...
    public function getTypeSQL($xmldb_type, $xmldb_length=null, $xmldb_decimals=null) {
        ...
        switch ($xmldb_type) {
            case XMLDB_TYPE_INTEGER:    // From https://mysql.com/doc/refman/5.0/en/numeric-types.html!
    ...
    public static function getReservedWords() {
        ...
        $reserved_words = array (
            // From https://dev.mysql.com/doc/refman/6.0/en/reserved-words.html.
