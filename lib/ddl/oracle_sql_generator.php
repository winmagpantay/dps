...
class oracle_sql_generator extends sql_generator {
    ...
    public function getResetSequenceSQL($table) {
        ...
        // From https://www.acs.ilstu.edu/docs/oracle/server.101/b10759/statements_2011.htm
    ...
    public function getTypeSQL($xmldb_type, $xmldb_length=null, $xmldb_decimals=null) {
        ...
        switch ($xmldb_type) {
            case XMLDB_TYPE_INTEGER:    // See https://www.acs.ilstu.edu/docs/oracle/server.101/b10759/sql_elements001.htm#sthref86.
    ...
    public function getAlterFieldSQL($xmldb_table, $xmldb_field, $skip_type_clause = NULL, $skip_default_clause = NULL, $skip_notnull_clause = NULL) {
        ...
        // because ADOdb has one bug here. https://phplens.com/lens/lensforum/msgs.php?id=15883
        if ($oldmetatype == 'N') {
    ...
    public static function getReservedWords() {
        ...
        // from https://download-uk.oracle.com/docs/cd/B10501_01/server.920/a96540/ap_keywd.htm
