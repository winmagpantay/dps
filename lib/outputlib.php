...
class theme_config {
     ...
     * {@link https://cvs.moodle.org/moodle/theme/base/config.php?view=markup the base theme config.php file}.
        ...
        if (is_readable($rendererfile)) {
            ...
            if (is_readable($this->dir.'/renderer.php')) {
                debugging('Developer hint: '.$this->dir.'/renderer.php should be renamed to ' . $this->dir."/renderers.php.
                    See: https://docs.moodle.org/dev/Output_renderers#Theme_renderers.", DEBUG_DEVELOPER);
            }
        }
