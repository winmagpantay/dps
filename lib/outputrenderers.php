 ...
 *
 * Please see {@link https://docs.moodle.org/en/Developement:How_Moodle_outputs_HTML}
 * for an overview.
 *
...
class core_renderer extends renderer_base {
    ...
    public function doctype() {
        if ($this->page->theme->doctype === 'html5') {
            ...
            // legacy xhtml 1.0
            $this->contenttype = 'text/html; charset=utf-8';
            return ('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">' . "\n");
        }
    }
    ...
    public function home_link() {
        ...
        if ($this->page->pagetype == 'site-index') {
            ...
            return '<div class="sitelink">' .
                   '<a title="Moodle" class="d-inline-block aalink" href="https://moodle.org/">' .
                   '<img src="' . $this->image_url('moodlelogo_grayhat') . '" alt="'.get_string('moodlelogo').'" /></a></div>';

        } else if (!empty($CFG->target_release) && $CFG->target_release != $CFG->release) {
            // Special case for during install/upgrade.
            return '<div class="sitelink">'.
                   '<a title="Moodle" href="https://docs.moodle.org/en/Administrator_documentation" onclick="this.target=\'_blank\'">' .
                   '<img src="' . $this->image_url('moodlelogo_grayhat') . '" alt="'.get_string('moodlelogo').'" /></a></div>';
