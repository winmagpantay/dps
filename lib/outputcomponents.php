 ...
 *
 * Please see https://docs.moodle.org/en/Developement:How_Moodle_outputs_HTML
 * for an overview.
 *
 * @package core
 * @category output
    ...
    public function get_url(moodle_page $page, renderer_base $renderer = null) {
        ...
        if ($this->user->picture == 0 and !empty($CFG->enablegravatar)) {
            ...
            if (is_https()) {
                ...
                return new moodle_url("https://www.gravatar.com/avatar/{$md5}", array('s' => $size, 'd' => $gravatardefault));
            }
        }
...
class custom_menu extends custom_menu_item {
     ...
     *
     * Example structure:
     *     First level first item|https://www.moodle.com/
     *     -Second level first item|https://www.moodle.com/partners/
     *     -Second level second item|https://www.moodle.com/hq/
     *     --Third level first item|https://www.moodle.com/jobs/
     *     -Second level third item|https://www.moodle.com/development/
     *     First level second item|https://www.moodle.com/feedback/
     *     First level third item
     *     English only|https://moodle.com|English only item|en
     *     German only|https://moodle.de|Deutsch|de,de_du,de_kids
     *
     *
     * @static
