 ...
 * @category   Horde
 * @package    Support
 * @license    https://www.horde.org/licenses/bsd
 */
class Horde_Support_Uuid
{
     ...
     * @see https://labs.omniti.com/alexandria/trunk/OmniTI/Util/UUID.php
     */
    public function generate()
    {
        ...
        if (extension_loaded('uuid')) {
            if (function_exists('uuid_export')) {
                // UUID extension from https://www.ossp.org/pkg/lib/uuid/
                ...
                // UUID extension from https://pecl.php.net/package/uuid
