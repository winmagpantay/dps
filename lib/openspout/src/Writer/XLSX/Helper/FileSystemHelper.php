...
final class FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    public function createWorkbookRelsFile(array $worksheets): self
    {
        $workbookRelsXmlFileContents = <<<'EOD'
            ...
            <Relationships xmlns="https://schemas.openxmlformats.org/package/2006/relationships">
                <Relationship Id="rIdStyles" Target="styles.xml" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/styles"/>
                <Relationship Id="rIdSharedStrings" Target="sharedStrings.xml" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings"/>
            EOD;

        /** @var Worksheet $worksheet */
        foreach ($worksheets as $worksheet) {
            $worksheetId = $worksheet->getId();
            $workbookRelsXmlFileContents .= '<Relationship Id="rIdSheet'.$worksheetId.'" Target="worksheets/sheet'.$worksheetId.'.xml" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet"/>';
        }
    ...
    public function createWorksheetRelsFiles(array $worksheets): self
    {
        ...
        foreach ($worksheets as $worksheet) {
            ...
            $worksheetRelsContent = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
              <Relationships xmlns="https://schemas.openxmlformats.org/package/2006/relationships">
                <Relationship Id="rId_comments_vml1" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/vmlDrawing" Target="../drawings/vmlDrawing'.$worksheetId.'.vml"/>
                <Relationship Id="rId_comments1" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/comments" Target="../comments'.$worksheetId.'.xml"/>
              </Relationships>';
    ...
    private function createRelsFile(): self
    {
        $relsFileContents = <<<'EOD'
            <?xml version="1.0" encoding="UTF-8"?>
            <Relationships xmlns="https://schemas.openxmlformats.org/package/2006/relationships">
                <Relationship Id="rIdWorkbook" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/>
                <Relationship Id="rIdCore" Type="https://schemas.openxmlformats.org/officedocument/2006/relationships/metadata/core-properties" Target="docProps/core.xml"/>
                <Relationship Id="rIdApp" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/extended-properties" Target="docProps/app.xml"/>
            </Relationships>
            EOD;
    ...
    private function createCoreXmlFile(): self
    {
        ...
        $coreXmlFileContents = <<<EOD
            <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
            <cp:coreProperties xmlns:cp="https://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="https://purl.org/dc/elements/1.1/" xmlns:dcmitype="https://purl.org/dc/dcmitype/" xmlns:dcterms="https://purl.org/dc/terms/" xmlns:xsi="https://www.w3.org/2001/XMLSchema-instance">
