 ...
 * @date  2016
 * @version  3.0.0
 * @license  GNU Lesser General Public License, version 3 (<https://www.gnu.org/licenses/lgpl.html>)
 */
 ...
 */
    function __construct($toolProvider, $toolProxyService, $secret)
    {
        ...
        $this->{'@context'} = array_merge(array('https://purl.imsglobal.org/ctx/lti/v2/ToolProxy'), $contexts);
        $this->{'@type'} = 'ToolProxy';
