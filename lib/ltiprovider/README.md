...
These classes are an extension of the LTI Tool Provider class library created by the ceLTIc project (https://www.spvsoftwareproducts.com/php/lti_tool_provider/).
