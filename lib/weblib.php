...
/**
 * Markdown-formatted text https://daringfireball.net/projects/markdown/
 */
...
function qualified_me() {
    ...
    if (isset($PAGE) and $PAGE->has_set_url()) {
        ...
        if (!empty($CFG->sslproxy)) {
            ...
            return preg_replace('/^https:/', 'https:', $FULLME, 1);
        } else {
            return $FULLME;
        }
    }
...
class moodle_url {
    ...
    public function set_scheme($scheme) {
        // See https://www.ietf.org/rfc/rfc3986.txt part 3.1.
     ...
     * https://www.example.org:447/my/file/is/here.txt?really=1 then this will
    ...
    switch ($format) {
        ...
        case FORMAT_WIKI:
            ...
            $text = '<p>NOTICE: Wiki-like formatting has been removed from Moodle.  You should not be seeing
                     ...
                     Please post a bug report to https://moodle.org/bugs with information about where you
...
function extract_draft_file_urls_from_text($text, $forcehttps = false, $contextid = null, $component = null,
    ...
    $wwwroot = $CFG->wwwroot;
    if ($forcehttps) {
        $wwwroot = str_replace('https://', 'https://', $wwwroot);
    }
...
function redirect($url, $message='', $delay=null, $messagetype = \core\output\notification::NOTIFY_INFO) {
    ...
    if (!preg_match('|^[a-z]+:|i', $url)) {
        // Get host name https://www.wherever.com.
 ...
 *
 * @copyright Petr Skoda {@link https://skodak.org}
 * @license https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @package core
 */
