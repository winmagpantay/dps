...
class core_text {
     ...
     * paravoid (https://www.php.net/manual/en/function.mb-encode-mimeheader.php#60283).
     *
     * @param string $text input string
     * @param string $charset encoding of the text
     ...
     * https://php.net/manual/en/function.html-entity-decode.php#75153
    ...
    /**
     * Removes the BOM from unicode string {@link https://unicode.org/faq/utf_bom.html}
     *
     * @param string $str input string
     * @return string
     */
