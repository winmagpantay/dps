...
class core_useragent {
    ...
    public static function check_ie_properties() {
        ...
        // See: https://www.useragentstring.com/pages/Internet%20Explorer/.
        if (preg_match("/MSIE ([0-9\.]+)/", $useragent, $match)) {
            $browser = $match[1];
        // See: https://msdn.microsoft.com/en-us/library/ie/bg182625%28v=vs.85%29.aspx for IE11+ useragent details.
    ...
    public static function check_ie_compatibility_view() {
        ...
        // - https://blogs.msdn.com/b/ie/archive/2011/04/15/the-ie10-user-agent-string.aspx.
    ...
    public static function supports_json_contenttype() {
        ...
        // Refs:
        // - https://blogs.msdn.com/b/ie/archive/2008/09/10/native-json-in-ie8.aspx;
