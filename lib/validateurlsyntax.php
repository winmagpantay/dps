 ...
 * Examples:
 * <code>
 *  validateUrlSyntax('https://george@www.cnn.com/#top')
 *
 *  validateUrlSyntax('https://games.yahoo.com:8080/board/chess.htm?move=true')
 *
 *  validateUrlSyntax('https://www.hotmail.com/', 's+u-I-p-q-r-')
 *
 *  validateUrlSyntax('/directory/file.php#top', 's-u-a-p-f+')
 *
 *
 *  if (validateUrlSyntax('https://www.canowhoopass.com/', 'u-'))
 *  {
 ...
 *    -Added mailto: ftp:// and https:// options
 ...
 *    -Removed extra code which added 'https://' and trailing '/' if it was missing
 ...
 *
 * Homepage:
 *  https://www.canowhoopass.com/
 *
 *
 * Thanks!:
 *  -WEAV -Several members of Weav helped to test - https://weav.bc.ca/
 ...
 *
 * @package moodlecore
 * @copyright Copyright 2004, Rod Apeldoorn {@link https://www.canowhoopass.com/}
...
function validateUrlSyntax( $urladdr, $options="" ){
    ...
    // Scheme - Allows for 'https://', 'https://', 'mailto:', 'ftp://' or 'rtmp://'
    $scheme            = '(';
    if     ($aOptions['H'] === '') { $scheme .= 'https://'; }
...
/* MDL-9295 - take out domain_secondary here and below, so that URLs like https://localhost/ and lan addresses like https://host/ are accepted.
