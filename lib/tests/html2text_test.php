...
class html2text_test extends \basic_testcase {
    ...
    public function test_build_link_list() {
        ...
        $text = 'Total of <a title="List of integrated issues"
            href="https://tr.mdl.org/sh.jspa?r=1&j=p+%3D+%22I+d%22+%3D">     ' . '
            <strong>27 issues</strong></a> and <a href="https://another.url/?f=a&amp;b=2">some</a> other
have been fixed <strong><a href="https://third.url/view.php">last week</a></strong>';
        ...
        $this->assertSame(1, preg_match('|^'.preg_quote('[1] https://tr.mdl.org/sh.jspa?r=1&j=p+%3D+%22I+d%22+%3D').'$|m', $result));
        $this->assertSame(1, preg_match('|^'.preg_quote('[2] https://another.url/?f=a&amp;b=2').'$|m', $result));
        $this->assertSame(1, preg_match('|^'.preg_quote('[3] https://third.url/view.php').'$|m', $result));
        $this->assertSame(false, strpos($result, '[4]'));

        // Test multiple occurrences of the same URL.
        $text = '<p>See <a href="https://moodle.org">moodle.org</a>,
            <a href="https://www.google.fr">google</a>, <a href="https://www.univ-lemans.fr">univ-lemans</a>
            and <a href="https://www.google.fr">google</a>.
        ...
        $this->assertSame(false, strpos($result, '[0]'));
        $this->assertSame(1, preg_match('|^'.preg_quote('[1] https://moodle.org').'$|m', $result));
        $this->assertSame(1, preg_match('|^'.preg_quote('[2] https://www.google.fr').'$|m', $result));
        $this->assertSame(1, preg_match('|^'.preg_quote('[3] https://www.univ-lemans.fr').'$|m', $result));
