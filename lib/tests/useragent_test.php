...
class useragent_test extends advanced_testcase {
    ...
    public function user_agents_providers() {
        ...
        return array(
            ...
            array(
                'msnbot-media/1.1 (+https://search.msn.com/msnbot.htm)',
                array(
                    'is_web_crawler'                => true,
                    'versionclasses'                => array(
                    ),
            ...
            // Yandex.
            // See https://help.yandex.com/search/robots/agent.xml.
            array(
            ...
            // Baidu.
            array(
                'Baiduspider+(+https://www.baidu.com/search/spider_jp.html)',
                array(
                    'is_web_crawler'                => true,
                    'versionclasses'                => array(
                    ),
            ...
            array(
                'Baiduspider+(+https://www.baidu.com/search/spider.htm)',
                array(
                    'is_web_crawler'                => true,
                    'versionclasses'                => array(
                    ),
