...
class weblib_test extends advanced_testcase {
    ...
    public function test_strip_links() {
        $this->assertSame('this is a link', strip_links('this is a <a href="https://someaddress.com/query">link</a>'));
    }
    ...
    public function test_wikify_links() {
        $this->assertSame('this is a link [ https://someaddress.com/query ]', wikify_links('this is a <a href="https://someaddress.com/query">link</a>'));
    }
