 ...
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later (5)
 */
class navigationlib_test extends \advanced_testcase {
    ...
    protected function setup_node() {
        ...
        $activeurl = $PAGE->url;
        $inactiveurl = new \moodle_url('https://www.moodle.com/');
    ...
    public function test_node__construct() {
        ...
        $fakeproperties = array(
            ...
            'action' => new \moodle_url('https://www.moodle.org/'));
    ...
    public function test_node_add() {
        ...
        $node1 = $this->node->add('test_add_1', 'https://www.moodle.org/', navigation_node::TYPE_COURSE, 'testadd1', 'key', new pix_icon('i/course', ''));
    ...
    public function test_node_check_if_active() {
        ...
        // Demo1 -> action is https://www.moodle.org/, thus should be true.
        ...
        // Demo2 -> action is https://www.moodle.com/, thus should be false.
