...
class update_api_test extends \advanced_testcase {
    ...
    public function test_validate_pluginfo_format() {
        ...
        // Download URL may be https:// or https:// only.
        $data = json_decode($json);
