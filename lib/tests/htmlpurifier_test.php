...
class htmlpurifier_test extends \basic_testcase {
    ...
    public function test_allow_blank_target() {
        ...
        // the rel attribute.
        $text = '<a href="https://moodle.org" target="_blank">Some link</a>';
        $expected = '<a href="https://moodle.org" target="_blank" rel="noreferrer noopener">Some link</a>';
        $result = format_text($text, FORMAT_HTML);
        $this->assertSame($expected, $result);

        $result = format_text('<a href="https://moodle.org" target="some">Some link</a>', FORMAT_HTML);
        $this->assertSame('<a href="https://moodle.org">Some link</a>', $result);
    }
...
<embed src="https://www.youtube.com/v/AyPzM5WK8ys" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350" />
</object>hmmm';
        $result = purify_html($text, array());
        ...
        $expected = '<object width="425" height="350" data="https://www.youtube.com/v/AyPzM5WK8ys" type="application/x-shockwave-flash">
<param name="allowScriptAccess" value="never" />
<param name="allowNetworking" value="internal" />
<param name="movie" value="https://www.youtube.com/v/AyPzM5WK8ys" />
<param name="wmode" value="transparent" />
<embed src="https://www.youtube.com/v/AyPzM5WK8ys" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350" allowscriptaccess="never" allownetworking="internal" />
</object>hmmm';
        $result = purify_html($text, array());
    ...
    public function test_cleaning_nastiness() {
        ...
        $text = 'x<OBJECT TYPE="text/x-scriptlet" DATA="https://ha.ckers.org/scriptlet.html"></OBJECT>x';
        $this->assertSame('xx', purify_html($text));

        $text = 'x<EMBED SRC="https://ha.ckers.org/xss.swf" AllowScriptAccess="always"></EMBED>x';
        $this->assertSame('xx', purify_html($text));
    ...
    public function test_idn() {
        ...
        $text = '<a href="https://правительство.рф">правительство.рф</a>';
        $expected = '<a href="https://xn--80aealotwbjpid2k.xn--p1ai">правительство.рф</a>';
        $this->assertSame($expected, purify_html($text));

        // Examples of deviations from https://www.unicode.org/reports/tr46/#Table_Deviation_Characters .
        $text = '<a href="https://teßt.de">teßt.de</a>';
        $expected = '<a href="https://xn--tet-6ka.de">teßt.de</a>';
        $this->assertSame($expected, purify_html($text));

        $text = '<a href="https://βόλος.com">https://βόλος.com</a>';
        $expected = '<a href="https://xn--nxasmm1c.com">https://βόλος.com</a>';
        $this->assertSame($expected, purify_html($text));

        $text = '<a href="https://نامه‌ای.com">https://نامه‌ای.com</a>';
        $expected = '<a href="https://xn--mgba3gch31f060k.com">https://نامه‌ای.com</a>';
        $this->assertSame($expected, purify_html($text));
    }
    ...
    public function media_tags_provider() {
        ...
        return $generatetestcases('Plain audio', $audioattrs + ['src="https://example.com/jam.wav"'], [
                ...
                '<audio %1$s><source src="https://example.com/getup.wav">No tasty jams for you.</audio>',
                '<div class="text_to_html">' .
                    '<audio %1$s>' .
                        '<source src="https://example.com/getup.wav" />' .
                        'No tasty jams for you.' .
                    '</audio>' .
                '</div>'
            ]) + $generatetestcases('Audio with multiple sources', $audioattrs, [
                '<audio %1$s>' .
                    '<source src="https://example.com/getup.wav" type="audio/wav">' .
                    '<source src="https://example.com/getup.mp3" type="audio/mpeg">' .
                    '<source src="https://example.com/getup.ogg" type="audio/ogg">' .
                    'No tasty jams for you.' .
                '</audio>',
                '<div class="text_to_html">' .
                    '<audio %1$s>' .
                ...
                '<audio %1$s>' .
                    '<source src="https://example.com/getup.wav" type="audio/wav">' .
                    '<track kind="subtitles" src="https://example.com/subtitles_en.vtt" label="English" srclang="en">' .
                    '<track kind="subtitles" src="https://example.com/subtitles_es.vtt" label="Espanol" srclang="es">' .
                    'No tasty jams for you.' .
                '</audio>',
                '<div class="text_to_html">' .
                    '<audio %1$s>' .
                    ...
                    '</audio>' .
                '</div>'
            ]) + $generatetestcases('Plain video', $videoattrs + ['src="https://example.com/prettygood.mp4'], [
                '<video %1$s>Oh, that\'s pretty bad 😦</video>',
                '<div class="text_to_html"><video %1$s>Oh, that\'s pretty bad 😦</video></div>'
            ]) + $generatetestcases('Video with illegal subtag', $videoattrs + ['src="https://example.com/prettygood.mp4'], [
                '<video %1$s><subtag></subtag>Oh, that\'s pretty bad 😦</video>',
                '<div class="text_to_html"><video %1$s>Oh, that\'s pretty bad 😦</video></div>'
            ]) + $generatetestcases('Video with legal subtag', $videoattrs + ['src="https://example.com/prettygood.mp4'], [
                '<video %1$s>Did not work <a href="https://example.com/prettygood.mp4">click here to download</a></video>',
                '<div class="text_to_html"><video %1$s>Did not work <a href="https://example.com/prettygood.mp4">' .
                'click here to download</a></video></div>'
            ]) + $generatetestcases('Video inside an inline tag', $videoattrs + ['src="https://example.com/prettygood.mp4'], [
                '<em><video %1$s>Oh, that\'s pretty bad 😦</video></em>',
                '<div class="text_to_html"><em><video %1$s>Oh, that\'s pretty bad 😦</video></em></div>'
            ]) + $generatetestcases('Video inside a block tag', $videoattrs + ['src="https://example.com/prettygood.mp4'], [
                ...
                'some text <source src="https://example.com/getup.wav" type="audio/wav"> the end',
                '<div class="text_to_html">some text  the end</div>'
            ]) + $generatetestcases('Video with one source', $videoattrs, [
                '<video %1$s><source src="https://example.com/prettygood.mp4">Oh, that\'s pretty bad 😦</video>',
                '<div class="text_to_html">' .
                    '<video %1$s>' .
                        '<source src="https://example.com/prettygood.mp4" />' .
                        'Oh, that\'s pretty bad 😦' .
                    '</video>' .
                '</div>'
            ]) + $generatetestcases('Video with multiple sources', $videoattrs, [
                '<video %1$s>' .
                    '<source src="https://example.com/prettygood.mp4" type="video/mp4">' .
                    '<source src="https://example.com/eljefe.mp4" type="video/mp4">' .
                    '<source src="https://example.com/turnitup.mov" type="video/mov">' .
                    'Oh, that\'s pretty bad 😦' .
                '</video>',
                '<div class="text_to_html">' .
                    '<video %1$s>' .
                ...
                '</div>'
                    ...
                    '<video src="https://example.com/turnitup.mov" crossorigin="can i pls hab?">' .
                        'Oh, that\'s pretty bad 😦' .
                    '</video>',
                    '<div class="text_to_html">' .
                        '<video src="https://example.com/turnitup.mov">' .
                           'Oh, that\'s pretty bad 😦' .
                        '</video>' .
                    '</div>'
            ]] + ['Audio with invalid crossorigin' => [
                    '<audio src="https://example.com/getup.wav" crossorigin="give me. the jams.">' .
                        'nyemnyemnyem' .
                    '</audio>',
                    '<div class="text_to_html">' .
                        '<audio src="https://example.com/getup.wav">' .
                            'nyemnyemnyem' .
                        '</audio>' .
                    '</div>'
            ]] + ['Other attributes' => [
                '<video src="https://example.com/turnitdown.mov" class="nofilter" data-something="data attribute" someattribute="somevalue" onclick="boom">' .
                    '<source src="https://example.com/getup.wav" type="audio/wav" class="shouldberemoved" data-sourcedata="source data" onmouseover="kill session" />' .
                    '<track src="https://example.com/subtitles_en.vtt" class="shouldberemoved" data-trackdata="track data" onmouseover="removeme" />' .
                    'Do not remove attribute class but remove other attributes' .
                '</video>',
                '<div class="text_to_html">' .
                    '<video src="https://example.com/turnitdown.mov" class="nofilter">' .
                        '<source src="https://example.com/getup.wav" type="audio/wav" />' .
                        '<track src="https://example.com/subtitles_en.vtt" />' .
                        'Do not remove attribute class but remove other attributes' .
                    '</video>' .
                '</div>'
            ]];
