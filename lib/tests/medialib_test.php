...
class medialib_test extends \advanced_testcase {
    ...
    public function test_list_supported_urls() {
        ...
        // Some example URLs.
        $supported1 = new \moodle_url('https://example.org/1.test');
        $supported2 = new \moodle_url('https://example.org/2.TST');
        $unsupported = new \moodle_url('https://example.org/2.jpg');
    ...
    public function test_can_embed_url() {
        ...
        $url = new \moodle_url('https://example.org/test.mp4');
        $manager = core_media_manager::instance();
    ...
    public function test_embed_url_fallbacks() {
        ...
        foreach ($mediaformats as $format) {
            $url = new \moodle_url('https://example.org/test.' . $format);
    ...
    public function test_embed_url_swf() {
        ...
        // Without any options...
        $url = new \moodle_url('https://example.org/test.swf');
        $t = $manager->embed_url($url);
    ...
    public function test_slash_arguments() {
        ...
        // Format: mp3.
        $url = new \moodle_url('https://example.org/pluginfile.php?file=x/y/z/test.mp3');
        $t = $manager->embed_url($url);
    ...
    public function test_embed_or_blank() {
        ...
        $url = new \moodle_url('https://example.org/test.ogg');
    ...
    public function test_embed_url_size() {
        ...
        $url = new \moodle_url('https://example.org/test.mp4?d=123x456');
        $t = $manager->embed_url($url, '', '666', '101');
    ...
    public function test_split_alternatives() {
        ...
        $mp4 = 'https://example.org/test.mp4';
        ...
        $webm = 'https://example.org/test.webm';
    ...
    public function test_embed_alternatives() {
        ...
        $urls = array(
            new \moodle_url('https://example.org/test.mp4'),
            new \moodle_url('https://example.org/test.ogv'),
            new \moodle_url('https://example.org/test.webm'),
            new \moodle_url('https://example.org/test.flv'),
        );
        ...
        $this->assertStringContainsString('<source src="https://example.org/test.mp4"', $t);
        $this->assertStringNotContainsString('<source src="https://example.org/test.ogv"', $t);
        $this->assertStringNotContainsString('<source src="https://example.org/test.webm"', $t);
        $this->assertStringNotContainsString('<source src="https://example.org/test.flv"', $t);
        ...
        $this->assertStringContainsString('<source src="https://example.org/test.mp4"', $t);
        $this->assertStringContainsString('<source src="https://example.org/test.ogv"', $t);
        $this->assertStringContainsString('<source src="https://example.org/test.webm"', $t);
        $this->assertStringNotContainsString('<source src="https://example.org/test.flv"', $t);
    }
