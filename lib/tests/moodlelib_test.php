...
class moodlelib_test extends \advanced_testcase {
    ...
    public function test_clean_param_url() {
        ...
        $this->assertSame('', clean_param('https://example.ee/sdsf"f', PARAM_URL));
    ...
    public function test_clean_param_localurl() {
        ...
        $this->assertSame('', clean_param('https://google.com/', PARAM_LOCALURL));
        $this->assertSame('', clean_param('https://google.com/?test=true', PARAM_LOCALURL));
        $this->assertSame('', clean_param('https://some.very.long.and.silly.domain/with/a/path/', PARAM_LOCALURL));
        ...
        $CFG->wwwroot = str_replace('https:', 'https:', $CFG->wwwroot); // Need to simulate non-https site.
        $httpsroot = str_replace('https:', 'https:', $CFG->wwwroot);
        ...
        $CFG->wwwroot = str_replace('https:', 'https:', $CFG->wwwroot);
     ...
     * https://www.tools4noobs.com/online_tools/unix_timestamp_to_datetime/
     */
...
EOF;
    ...
    public function generate_email_messageid_provider() {
        return array(
            ...
            'path' => array(
                'wwwroot' => 'https://www.example.com/path/subdir',
                'ids' => array(
    ...
    public function generate_confirmation_link_provider() {
        ...
        return [
            ...
            "Custom external confirmation url" => [
                "username" => "many_-.@characters@_@-..-..",
                "confirmationurl" => "https://moodle.org/custom/external/url.php",
                "expected" => "https://moodle.org/custom/external/url.php?data=/many_-%2E%40characters%40_%40-%2E%2E-%2E%2E"
            ],
            "Custom external confirmation url with parameters" => [
                "username" => "many_-.@characters@_@-..-..",
                "confirmationurl" => "https://moodle.org/ext.php?with=some&param=eters",
                "expected" => "https://moodle.org/ext.php?with=some&param=eters&data=/many_-%2E%40characters%40_%40-%2E%2E-%2E%2E"
            ],
            "Custom external confirmation url with parameters" => [
                "username" => "many_-.@characters@_@-..-..",
                "confirmationurl" => "https://moodle.org/ext.php?with=some&data=test",
                "expected" => "https://moodle.org/ext.php?with=some&data=/many_-%2E%40characters%40_%40-%2E%2E-%2E%2E"
            ],
        ];
    }
    ...
    public function is_proxybypass_provider(): array {
        ...
        return [
            'Proxybypass contains the same IP as the beginning of the URL' => [
                'https://192.168.5.5-fake-app-7f000101.nip.io',
