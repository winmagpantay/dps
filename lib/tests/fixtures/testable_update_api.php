...
class testable_api extends api {
    ...
    protected function get_serviceurl_pluginfo() {
        return 'https://testab.le/api/pluginfo.php';
    }
    ...
    protected function call_service($serviceurl, array $params=array()) {
        ...
        $version2015093000info = (object)array(
            ...
            'release' => '1.0',
            'maturity' => '200',
            'downloadurl' => 'https://mood.le/plugins/foo_bar/2015093000.zip',
        ...
        $version2015100400info = (object)array(
            ...
            'release' => '1.1',
            'maturity' => '200',
            'downloadurl' => 'https://mood.le/plugins/foo_bar/2015100400.zip',
            'downloadmd5' => 'd41d8cd98f00b204e9800998ecf8427e',
            'vcssystem' => '',
            'vcssystemother' => '',
            'vcsrepositoryurl' => '',
        ...
        $version2015100500info = (object)array(
            ...
            'release' => '2.0beta',
            'maturity' => '100',
            'downloadurl' => 'https://mood.le/plugins/foo_bar/2015100500.zip',
            'downloadmd5' => 'd41d8cd98f00b204e9800998ecf8427e',
            'vcssystem' => '',
            'vcssystemother' => '',
            'vcsrepositoryurl' => '',
        ...
        if ($serviceurl === 'https://testab.le/api/pluginfo.php') {
