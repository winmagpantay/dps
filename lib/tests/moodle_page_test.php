...
class moodle_page_test extends \advanced_testcase {
    ...
    public function test_url_to_class_name() {
        $this->assertSame('example-com', $this->testpage->url_to_class_name('https://example.com'));
        $this->assertSame('example-com--80', $this->testpage->url_to_class_name('https://example.com:80'));
