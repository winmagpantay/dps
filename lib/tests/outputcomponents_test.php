...
class outputcomponents_test extends \advanced_testcase {
    ...
    public function test_get_url() {
        ...
        $up2 = new user_picture($user2);
        $this->assertSame('https://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=mm', $up2->get_url($page, $renderer)->out(false));

        // Without gravatardefaulturl, verify we pick own file.
        set_config('gravatardefaulturl', '');
        $up2 = new user_picture($user2);
        $this->assertSame('https://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Fmoodle%2Fpix%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
        ...
        // $up2 = new user_picture($user2);
        // $this->assertEquals('https://www.gravatar.com/avatar/ab53a2911ddf9b4817ac01ddcd3d975f?s=35&d=http%3A%2F%2Fwww.example.com%2Fmoodle%2Ftheme%2Fafterburner%2Fpix_core%2Fu%2Ff2.png', $up2->get_url($page, $renderer)->out(false));
...
-Hosting|https://moodle.com/hosting|Commercial hosting
-Support|https://moodle.com/support|Commercial support
EOF;
        ...
        $this->assertEquals('https://moodle.org', $itemurl->out());
    ...
    public function test_custommenu_mulitlang() {
        $definition = <<<EOF
Start|https://school.info
Info
-English|https://school.info/en|Information in English|en
--Nested under English
--I will be lost|||de
-Deutsch|https://school.info/de|Informationen in deutscher Sprache|de,de_du,de_kids
