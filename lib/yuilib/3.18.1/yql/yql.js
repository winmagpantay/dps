...
/**
 * This class adds a sugar class to allow access to YQL (https://developer.yahoo.com/yql/).
 * @module yql
 */
/**
...
* @static
* @property ENV
* @description The environment file to load: https://datatables.org/alltables.env
*/
YQLRequest.ENV = 'https:/' + '/datatables.org/alltables.env';
