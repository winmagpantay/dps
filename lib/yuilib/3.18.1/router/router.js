...
Y.Router = Y.extend(Router, Y.Base, {
    ...
    **/
    removeRoot: function (url) {
        ...
        // "https://foo.com"), so that we're left with just the path.
    ...
    **/
    ...
    @example
        ...
        // New URL: https://example.com/path?foo=bar
    ...
    **/
    ...
    @example
        app._upgradeURL('https://example.com/#/foo/'); // => 'https://example.com/foo/';
    ...
    ATTRS: {
        ...
        **/
        html5: {
            ...
            //
            // See https://code.google.com/p/android/issues/detail?id=17471
        ...
        **/
        ...
        `https://example.com/myapp/` and you add a route with the path `/`, your
        route will never execute, because the path will always be preceded by
        `/myapp`. Setting `root` to `/myapp` would cause all routes to be
        evaluated relative to that root URL, so the `/` route would then execute
        when the user browses to `https://example.com/myapp/`.
