...
(function () {
	...
	Lang.extend(Prog, YAHOO.util.Element, {
		...
		/** 
		 * Temporary solution until https://yuilibrary.com/projects/yui2/ticket/2528222 gets solved.
		 * Also fixes: https://yuilibrary.com/projects/yui2/ticket/2528919.
		...
		_valueChange: function (value, noAnim) {
			...
			if (this._rendered) {
				if (anim) {
					anim.stop();
					if (anim.isAnimated()) { anim._onComplete.fire(); } // see: https://yuilibrary.com/projects/yui2/ticket/2528217
				}
