 ...
 * @param sQuery {String} Original request.
 * @param oResponse {Object} <a href="https://developer.yahoo.com/yui/datasource/#ds_oParsedResponse">Response object</a>.
...
YAHOO.widget.AutoComplete.prototype._focus = function() {
    // https://developer.mozilla.org/en/docs/index.php?title=Key-navigable_custom_DHTML_widgets
    var oSelf = this;
    setTimeout(function() {
        try {
