 ...
 * @package    core
 * @subpackage lib
 * @copyright  2008 Petr Skoda  {@link https://skodak.org}
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 ...
 *
 * @package    core_access
 * @copyright  2010 Petr Skoda  {@link https://skodak.org}
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 ...
 *
 * @package    core_access
 * @copyright  2009 Petr Skoda  {@link https://skodak.org}
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 ...
 * @package    core
 * @subpackage lib
 * @copyright  2009 onwards Martin Dougiamas  {@link https://moodle.com}
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 ...
 * E.g. 'group/import' may become 'https://docs.moodle.org/2x/en/group/import'.
 * The 'https://docs.moodle.org' bit comes from $CFG->docroot.
 *
 ...
 *
 * 2. $path may be an absolute URL, starting https:// or https://. In this case,
 ...
 * @return string The MoodleDocs URL in the user's language. for example @link https://docs.moodle.org/2x/en/$path}
 */
function get_docs_url($path = null) {
    ...
    if (substr($path, 0, 7) === 'https://' || substr($path, 0, 8) === 'https://') {
        return $path;
    }
