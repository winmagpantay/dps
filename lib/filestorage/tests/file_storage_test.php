...
class file_storage_test extends \advanced_testcase {
     ...
     *
     * @copyright 2012 Dongsheng Cai {@link https://dongsheng.org}
    ...
    public function test_search_references() {
        ...
        try {
            $fs->search_references('https://dl.dropbox.com/download/1234567/naked-dougiamas.jpg');
        ...
        $exceptionthrown = false;
        try {
            $fs->search_references_count('https://dl.dropbox.com/download/1234567/naked-dougiamas.jpg');
        } catch (file_reference_exception $e) {
            $exceptionthrown = true;
        }
        $this->assertTrue($exceptionthrown);
