 ...
 * Sourceforge Project Page: {@link https://www.sourceforge.net/projects/phpflickr/}
 * Released under GNU Lesser General Public License ({@link https://www.gnu.org/copyleft/lgpl.html})
 * For more information about the class and upcoming tools and toys using it,
 * visit {@link https://www.phpflickr.com/} or {@link https://phpflickr.sourceforge.net}
 *
 ...
 *    {@link https://www.phpflickr.com/README.txt}
 *
 *   Please submit all problems or questions to the Help Forum on my project page:
 *     {@link https://sourceforge.net/forum/forum.php?forum_id=469652}
 *
 ...
 *   2. upload() method supports all params provided by https://www.flickr.com/services/api/upload.api.html
...
class phpFlickr {
    ...
    function auth ($perms = "write", $remember_uri = true)
    {
        ...
        $url = 'https://www.flickr.com/services/auth/?api_key=' . $this->api_key . "&perms=" .  $perms . '&api_sig='. $api_sig;
        return $url;
    }
     ...
     * content_type and hidden {@see https://www.flickr.com/services/api/upload.api.html}
     *
