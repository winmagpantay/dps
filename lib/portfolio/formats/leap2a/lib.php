...
class portfolio_format_leap2a_writer {
    ...
    public function __construct(stdclass $user) { // todo something else - exporter, format, etc
        ...
        $this->feed->setAttribute('xmlns', 'https://www.w3.org/2005/Atom');
        $this->feed->setAttribute('xmlns:rdf', 'https://www.w3.org/1999/02/22-rdf-syntax-ns#');
        $this->feed->setAttribute('xmlns:leap2', 'https://terms.leapspecs.org/');
        $this->feed->setAttribute('xmlns:categories', 'https://wiki.leapspecs.org/2A/categories');
        ...
        $this->feed->appendChild($this->dom->createElement('leap2:version', 'https://www.leapspecs.org/2010-07/2A/'));
     ...
     * @param string $selectiontype for selection type, see: https://wiki.cetis.ac.uk/2009-03/LEAP2A_categories/selection_type
     */
...
class portfolio_format_leap2a_entry {
     ...
     * https://wiki.cetis.ac.uk/2009-03/LEAP2A_types
     *
     ...
     * {@link https://wiki.cetis.ac.uk/2009-03/LEAP2A_relationships}
     *
     ...
     * {@link https://wiki.cetis.ac.uk/2009-03/LEAP2A_categories}
    ...
    public function add_category($term, $scheme=null, $label=null) {
        ...
        // see https://wiki.cetis.ac.uk/2009-03/LEAP2A_categories#Plain_tags for more information
    ...
    private function create_xhtmlish_element(DomDocument $dom, $tagname, $content) {
        ...
        if ($maybexml && @$tmp->loadXML('<div>' . $content . '</div>')) {
            ...
            $content->setAttribute('xmlns', 'https://www.w3.org/1999/xhtml');
