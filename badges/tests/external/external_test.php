...
class external_test extends externallib_advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $badge->imageauthorurl = 'https://image-author-url.domain.co.nz';
        ...
        $endorsement->issuerurl = 'https://endorsement-issuer-url.domain.co.nz';
        $endorsement->issueremail = 'endorsementissuer@example.com';
        $endorsement->claimid = 'https://claim-url.domain.co.nz';
        ...
        $alignment->targeturl = 'https://a1-target-url.domain.co.nz';
        ...
        $alignment->targeturl = 'https://a2-target-url.domain.co.nz';
