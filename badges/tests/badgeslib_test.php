 ...
 * @package    core
 * @subpackage badges
 * @copyright  2013 onwards Totara Learning Solutions Ltd {@link https://www.totaralms.com/}
...
class badgeslib_test extends advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $fordb->issuerurl = "https://issuer-url.domain.co.nz";
        ...
        $fordb->imageauthorurl = "https://author-url.example.com";
        ...
        $alignment->targeturl = 'https://www.corestandards.org/ELA-Literacy/RST/11-12/3';
    ...
    public function test_badges_get_user_badges() {
        ...
        for ($i = 1; $i <= 11; $i++) {
            ...
            $badge->issuerurl = "https://issuer-url.domain.co.nz";
    ...
    public function test_alignments() {
        ...
        $alignment1->targeturl = 'https://www.corestandards.org/ELA-Literacy/RST/11-12/3';
