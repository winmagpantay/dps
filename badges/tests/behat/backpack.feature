...
Feature: Backpack badges
  ...
  Scenario: Verify backback settings
    Given the following "core_badges > Badge" exists:
      ...
      | imageauthorurl | https://author.example.com        |
  ...
  Scenario: Add a new site backpack
    ...
    And I set the field "backpackapiurl" to "https://backpackapiurl.cat"
    And I set the field "backpackweburl" to "aaa"
    And I press "Save changes"
    And I should see "Invalid URL"
    And I set the field "backpackweburl" to "https://backpackweburl.cat"
    And I press "Save changes"
    Then I should see "https://backpackweburl.cat"
    And "Delete" "icon" should exist in the "https://backpackweburl.cat" "table_row"
    And "Edit settings" "icon" should exist in the "https://backpackweburl.cat" "table_row"
  ...
  Scenario: Add a new site backpack with authentication details checkbox
    ...
    And I press "Save changes"
    And I click on "Edit" "link" in the "https://backpackweburl.cat" "table_row"
