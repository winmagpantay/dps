...
class sitepolicy_test extends advanced_testcase {
    ...
    public function test_is_defined() {
        ...
        $CFG->sitepolicy = 'https://example.com/sitepolicy.html';
        $this->assertFalse($manager->is_defined(true));
        $this->assertTrue($manager->is_defined(false));

        $CFG->sitepolicyguest = 'https://example.com/sitepolicyguest.html';
    ...
    public function test_accept_guests() {
        ...
        // With site policy.
        $CFG->sitepolicyguest = 'https://example.com/sitepolicy.html';
    ...
    public function test_get_redirect_url_with_handler() {
        ...
        $this->assertEquals('https://example.com/policy.php', $manager->get_redirect_url(true)->out(false));
        $this->assertEquals('https://example.com/policy.php', $manager->get_redirect_url(false)->out(false));
    }
    ...
    public function test_get_embed_url_with_handler() {
        ...
        $this->assertEquals('https://example.com/view.htm', $manager->get_embed_url(true)->out(false));
        $this->assertEquals('https://example.com/view.htm', $manager->get_embed_url(false)->out(false));
    }
...
class handler extends \core_privacy\local\sitepolicy\handler {
    ...
    public static function get_redirect_url($forguests = false) {
        return 'https://example.com/policy.php';
    }
    ...
    public static function get_embed_url($forguests = false) {
        return 'https://example.com/view.htm';
    }
