...
class core_admin_renderer extends plugin_renderer_base {
    ...
    public function install_licence_page() {
        ...
        $output .= $this->header();
        $output .= $this->heading('<a href="https://moodle.org">Moodle</a> - Modular Object-Oriented Dynamic Learning Environment');
    ...
    protected function moodle_copyright() {
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////////
        ////  IT IS ILLEGAL AND A VIOLATION OF THE GPL TO HIDE, REMOVE OR MODIFY THIS COPYRIGHT NOTICE ///
        $copyrighttext = '<a href="https://moodle.org/">Moodle</a> '.
                         '<a href="https://moodledev.io/general/releases" title="'.$CFG->version.'">'.$CFG->release.'</a><br />'.
                         'Copyright &copy; 1999 onwards, Martin Dougiamas<br />'.
                         'and <a href="https://moodle.org/dev">many other contributors</a>.<br />'.
