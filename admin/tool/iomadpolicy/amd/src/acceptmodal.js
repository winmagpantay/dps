...
define([
    ...
    FormChangeChecker
        ...
        AcceptOnBehalf.prototype.init = function() {
            ...
            $(this.triggers.BULK).on('click', function(e) {
                ...
                if (form.find('input[type=checkbox][name="userids[]"]:checked').length) {
                    ...
                    Str.get_strings([
                        {key: 'notice'},
                        {key: 'selectusersforconsent', component: 'tool_iomadpolicy'},
                        {key: 'ok'}
        ...
        AcceptOnBehalf.prototype.showFormModal = function(formData) {
            ...
            Str.get_strings([
                {key: 'statusformtitleaccept', component: 'tool_iomadpolicy'},
                {key: 'iagreetotheiomadpolicy', component: 'tool_iomadpolicy'},
                {key: 'statusformtitlerevoke', component: 'tool_iomadpolicy'},
                {key: 'irevoketheiomadpolicy', component: 'tool_iomadpolicy'},
                {key: 'statusformtitledecline', component: 'tool_iomadpolicy'},
                {key: 'declinetheiomadpolicy', component: 'tool_iomadpolicy'}
            ]).then(function(strings) {
                var title;
                var saveText;
                if (action == 'accept') {
        ...
        AcceptOnBehalf.prototype.getBody = function(formData) {
            ...
            return Fragment.loadFragment('tool_iomadpolicy', 'accept_on_behalf', this.contextid, params);
        };
        ...
        AcceptOnBehalf.prototype.submitFormAjax = function(e) {
            ...
            var requests = Ajax.call([{
                methodname: 'tool_iomadpolicy_submit_accept_on_behalf',
        ...
        return /** @alias module:tool_iomadpolicy/acceptmodal */ {
