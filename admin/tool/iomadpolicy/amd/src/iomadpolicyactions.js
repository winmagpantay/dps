 ...
 * Policy actions.
 *
 * @module     tool_iomadpolicy/iomadpolicyactions
...
function($, Ajax, Notification, ModalFactory, ModalEvents) {
    ...
    PolicyActions.prototype.registerEvents = function(root) {
        root.on("click", function(e) {
            ...
            var request = {
                methodname: 'tool_iomadpolicy_get_iomadpolicy_version',
                args: params
            };
            ...
            $.when(promises[0]).then(function(data) {
                if (data.result.iomadpolicy) {
                    modalTitle.resolve(data.result.iomadpolicy.name);
                    modalBody.resolve(data.result.iomadpolicy.content);
    ...
    return /** @alias module:tool_iomadpolicy/iomadpolicyactions */ {
