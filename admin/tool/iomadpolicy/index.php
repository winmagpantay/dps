...
/**
 * Show a user the iomadpolicy documents to be agreed to.
 *
 * Script parameters:
 *  listdoc=<array> List of iomadpolicy version ids that were displayed to the user to accept.
 *  statusXX=<int> Acceptance status to be set for the iomadpolicy version with id XX.
...
use tool_iomadpolicy\output\page_agreedocs;
...
$PAGE->set_url('/admin/tool/iomadpolicy/index.php');
...
if (!$haspermissionagreedocs) {
    ...
    $outputpage = new \tool_iomadpolicy\output\page_agreedocs($listdocs, $agreedocs, $declinedocs, $behalfid, $submit);
}
