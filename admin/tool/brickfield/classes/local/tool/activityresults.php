...
class activityresults extends tool {
    ...
    public static function toolname(): string {
        return get_string('activityresults:toolname', 'tool_brickfield');
    }
    ...
    public static function toolshortname(): string {
        return get_string('activityresults:toolshortname', 'tool_brickfield');
    }
    ...
    protected function fetch_data(): \stdClass {
        ...
        $data = (object)[
            'valid' => true,
            'error' => '',
            'data' => (new sitedata())->get_component_data($filter),
        ];
