...
Complete Documentation:
  ...
  https://docs.moodle.org/en/XMLDB_Defining_one_XML_structure
...
to https://your.server/moodle/admin/xmldb
...
will be sent to https://docs.moodle.org/en/XML_database_schema in order
