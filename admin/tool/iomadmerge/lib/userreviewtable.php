...
class UserReviewTable extends html_table implements renderable
{
    ...
    /** @var tool_iomadmerge_renderer Render to help showing user info. */
    protected $renderer;
    ...
    protected function buildtable()
    {
        ...
        if (!empty($this->olduser) || !empty($this->newuser)) { // if there is a user add table rows and columns
            ...
            // Add old user row
            $olduserrow = array();
            $olduserrow[] = get_string('olduser', 'tool_iomadmerge');
            ...
            // Add new user row
            $newuserrow = array();
            $newuserrow[] = get_string('newuser', 'tool_iomadmerge');
