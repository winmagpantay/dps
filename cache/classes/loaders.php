...
class cache implements cache_loader {
     ...
     * $cache->set('main', 'https://moodle.org');
     * $cache->set('docs', 'https://docs.moodle.org');
     * $cache->set('tracker', 'https://tracker.moodle.org');
     * $cache->set('qa', 'https://qa.moodle.net');
     * </code>
     *
     * @param string|int $key The key for the data being requested.
     *      It can be any structure although using a scalar string or int is recommended in the interests of performance.
