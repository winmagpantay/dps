        ...
        return [
            'fill-in with case sensitive' => [
                'result' => [
                    ...
                    'response' => 'Cat[,]dog',
                    'additionals' => '{"extensions":{"https:\\/\\/h5p.org\\/x-api\\/h5p-local-content-id":31,'
            ...
            'sort the paragraph text' => [
                'result' => [
                    ...
                    'additionals' => '{"choices":[{"id":0,"description":{"en":"First I wake up at 7.30 am\\n",'
                        ...
                        .
                        '"extensions":{"https:\\/\\/h5p.org\\/x-api\\/h5p-local-content-id":39,'
            ...
            'sequencing images' => [
                'result' => [
                    ...
                    'additionals' => '{"choices":[{"id":"item_3","description":{"en-US":"Mercury"}},'
                        ...
                        . '{"https:\/\/h5p.org\/x-api\/h5p-local-content-id":43},"contextExtensions":{}}',
                ],
                'useranswers' => [
                    (object) ['answer' => 'Correct answer', 'pass' => true, ],
                    (object) ['answer' => 'Correct answer', 'pass' => true, ],
