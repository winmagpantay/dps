...
class mod_h5pactivity_generator extends testing_module_generator {
    ...
    public function create_content($instance, $record = []) {
        ...
        $result = (object)[
                ...
                'correctpattern' => '',
                'response' => '',
                'additionals' => '{"extensions":{"https:\/\/h5p.org\/x-api\/h5p-local-content-id":'.
        ...
        $result->additionals = '{"choices":[{"id":"0","description":{"en-US":"Blueberry\n"}},'.
                ...
                '"extensions":{"https:\/\/h5p.org\/x-api\/h5p-local-content-id":'.$cmid.
                ',"https:\/\/h5p.org\/x-api\/h5p-subContentId":"'.$result->interactiontype.
                '"},"contextExtensions":{}}';
        $result->rawscore = 1;
        $result->scaled = 0.2;
        $DB->insert_record('h5pactivity_attempts_results', $result);
    ...
    private function get_attempt_result_compound(array $attemptinfo): array {
        $additionals = (object)[
            "extensions" => (object)[
                "https://h5p.org/x-api/h5p-local-content-id" => 1,
            ],
    ...
    private function get_attempt_result_choice(array $attemptinfo): array {
        ...
        $additionals = (object)[
            ...
            "extensions" => (object)[
                "https://h5p.org/x-api/h5p-local-content-id" => 1,
                "https://h5p.org/x-api/h5p-subContentId" => "4367a919-ec47-43c9-b521-c22d9c0c0d8d",
            ],
            "contextExtensions" => (object)[],
        ];
    ...
    private function get_attempt_result_matching(array $attemptinfo): array {
        ...
        $additionals = (object)[
            ...
            "extensions" => [
                "https://h5p.org/x-api/h5p-local-content-id" => 1,
                "https://h5p.org/x-api/h5p-subContentId" => "682f1c74-c819-4e9d-8c36-12d9dc5fcdbc",
            ],
            "contextExtensions" => (object)[],
        ];
    ...
    private function get_attempt_result_fillin(array $attemptinfo): array {
        ...
        $additionals = (object)[
            "extensions" => (object)[
                "https://h5p.org/x-api/h5p-local-content-id" => 1,
                "https://h5p.org/x-api/h5p-subContentId" => "1a3febd5-7edc-4336-8112-12756b945b62",
    ...
    private function get_attempt_result_truefalse(array $attemptinfo): array {
        ...
        $additionals = (object)[
            "extensions" => (object)[
                "https://h5p.org/x-api/h5p-local-content-id" => 1,
                "https://h5p.org/x-api/h5p-subContentId" => "5de9fb1e-aa03-4c9a-8cf0-3870b3f012ca",
            ],
            "contextExtensions" => (object)[],
        ];
