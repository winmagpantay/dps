 ...
 *
 * @package    mod_lti
 * @copyright  Copyright (c) 2012 Moodlerooms Inc. (https://www.moodlerooms.com)
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class locallib_test extends mod_lti_testcase {
    ...
    public function disabled_test_sign_parameters() {
        ...
        $parms = lti_sign_parameters($requestparams, 'https://www.imsglobal.org/developer/LTI/tool.php', 'POST',
...
';
    ...
    public function test_lti_get_url_thumbprint() {
        ...
        $this->assertEquals('moodle.org/', lti_get_url_thumbprint('https://MOODLE.ORG'));
    ...
    public function test_lti_load_type_from_cartridge() {
        ...
        $this->assertEquals('https://www.example.com/lti/provider.php', $type->lti_toolurl);
        $this->assertEquals('https://download.moodle.org/unittest/test.jpg', $type->lti_icon);
    ...
    public function test_lti_load_tool_from_cartridge() {
        ...
        $this->assertEquals('https://www.example.com/lti/provider.php', $lti->toolurl);
        $this->assertEquals('https://www.example.com/lti/provider.php', $lti->securetoolurl);
        $this->assertEquals('https://download.moodle.org/unittest/test.jpg', $lti->icon);
...
-----END PUBLIC KEY-----';
    ...
    public function test_lti_convert_content_items() {
        ...
        $contentitems[] = [
            ...
            'url' => 'https://example.com/messages/launch',
            'title' => 'Test title',
            'text' => 'Test text',
            'iframe' => []
        ];
        $contentitems[] = [
            'type' => 'ltiResourceLink',
            'url' => 'https://example.com/messages/launch2',
            'title' => 'Test title2',
            'text' => 'Test text2',
            'iframe' => [
                'height' => 200,
        ...
        $contentitems[] = [
            'type' => 'ltiResourceLink',
            'url' => 'https://example.com/messages/launch3',
            'title' => 'Test title3',
            'text' => 'Test text3',
            'window' => [
                'targetName' => 'test-win',
        ...
        $objgraph->url = 'https://example.com/messages/launch';
        ...
        $objgraph2->url = 'https://example.com/messages/launch2';
        ...
        $objgraph3->url = 'https://example.com/messages/launch3';
        ...
        $expected->{$strcontext} = 'https://purl.imsglobal.org/ctx/lti/v1/ContentItem';
        $expected->{$strgraph} = [];
    ...
    public function test_lti_tool_configuration_from_content_item_single_gradable() {
        ...
        $type = new \stdClass();
        $type->name = "Test tool";
        $type->baseurl = "https://example.com";
        $config = new \stdClass();
    ...
    public function test_lti_tool_configuration_from_content_item_multiple() {
        ...
        $contentitems[] = [
            'type' => 'ltiResourceLink',
            'url' => 'https://example.com/messages/launchgraded',
            'title' => 'Test Graded',
            'lineItem' => [
                'resourceId' => 'r12345',
                'tag' => 'final',
...
-----END PUBLIC KEY-----';
    ...
    public function lti_get_ims_role_provider() {
        return [
            ...
            'Admin, LTI 2.0, no role switch' => [
                ...
                'rolename' => 'admin',
                'switchedto' => null,
                'expected' => 'Instructor,https://purl.imsglobal.org/vocab/lis/v2/person#Administrator'
            ],
    ...
    public function test_empty_reponse_lti_load_cartridge() {
        ...
        lti_load_cartridge('https://example.com/mocked/empty/response', []);
    }
