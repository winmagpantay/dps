...
class wikiparser_test extends \basic_testcase {
    ...
    public function urls_inside_link_text_provider() {
        return [
            ...
            'creole explicit link with text' => [
                'markup' => 'creole',
                'input' => 'Visit [[https://site.url|https://www.site.url]] for more information.',
                'output' => 'Visit <a href="https://site.url">https://www.site.url</a> for more information.',
            ],
            'nwiki implicit link' => [
                'markup' => 'nwiki',
                'input' => 'Visit https://site.url for more information.',
            ...
            'html explicit link with text' => [
                'markup' => 'html',
                'input' => 'Visit <a href="https://site.url">https://www.site.url</a> for more information.',
                'output' => 'Visit <a href="https://site.url">https://www.site.url</a> for more information.',
            ],
    ...
    public function test_special_headings() {
        ...
        $input = '<h1>Another https://moodle.org test</h1>';
        $output = '<h3><a name="toc-1"></a>Another <a href="https://moodle.org">https://moodle.org</a> test <a href="edit.php'.
            '?pageid=&amp;section=Another+http%3A%2F%2Fmoodle.org+test" class="wiki_edit_section">[edit]</a></h3>' . "\n";
        $toc = '<div class="wiki-toc"><p class="wiki-toc-title">Table of contents</p><p class="wiki-toc-section-1 '.
            'wiki-toc-section">1. <a href="#toc-1">Another https://moodle.org test <a href="edit.php?pageid=&amp;section='.
            'Another+http%3A%2F%2Fmoodle.org+test" class="wiki_edit_section">[edit]</a></a></p></div>';
        $section = wiki_parser_proxy::get_section($input, 'html', 'Another https://moodle.org test');
        ...
        $input = '= Another https://moodle.org test =';
        $output = '<h3><a name="toc-1"></a>Another https://moodle.org test <a href="edit.php'.
            '?pageid=&amp;section=Another+http%3A%2F%2Fmoodle.org+test" class="wiki_edit_section">[edit]</a></h3>' . "\n";
        $toc = '<div class="wiki-toc"><p class="wiki-toc-title">Table of contents</p><p class="wiki-toc-section-1 '.
            'wiki-toc-section">1. <a href="#toc-1">Another https://moodle.org test <a href="edit.php?pageid=&amp;section='.
            'Another+http%3A%2F%2Fmoodle.org+test" class="wiki_edit_section">[edit]</a></a></p></div>';
        $section = wiki_parser_proxy::get_section($input, 'creole', 'Another https://moodle.org test');
        $actual = wiki_parser_proxy::parse($input, 'creole');
        $this->assertEquals($output, $actual['parsed_text']);
        $this->assertEquals($toc, $actual['toc']);
        $this->assertNotEquals(false, $section);
        ...
        $toc = '<div class="wiki-toc"><p class="wiki-toc-title">Table of contents</p><p class="wiki-toc-section-1 '.
            'wiki-toc-section">1. <a href="#toc-1">Another https://moodle.org test <a href="edit.php?pageid=&amp;section='.
            'Another+http%3A%2F%2Fmoodle.org+test" class="wiki_edit_section">[edit]</a></a></p></div>';
        $section = wiki_parser_proxy::get_section($input, 'nwiki', 'Another https://moodle.org test');
        $actual = wiki_parser_proxy::parse($input, 'nwiki');
        $this->assertEquals($output, $actual['parsed_text']);
        $this->assertEquals($toc, $actual['toc']);
        $this->assertNotEquals(false, $section);
