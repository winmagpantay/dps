...
Feature: Users can use the Resources preset
  ...
  Background:
    ...
    And the following "mod_data > entries" exist:
      ...
      | data1    | student1 | My favourite book    | Book content   | Type1 | The book author    | https://myfavouritebook.cat    | first.png  |
      | data1    | teacher1 | My favourite podcast | Podcast content| Type2 | The podcast author | https://myfavouritepodcast.cat | second.png |
  ...
  Scenario: Resources. Users view entries
    ...
    And I should see "https://myfavouritebook.cat"
    ...
    And I should see "https://myfavouritepodcast.cat"
    ...
    And I should not see "https://myfavouritepodcast.cat"
    And I should not see "Podcast content"
    And I follow "Next"
    And I should see "My favourite podcast"
    And I should see "Type2"
    ...
    And I should not see "https://myfavouritebook.cat"
    And I should not see "Book content"
