...
class search_test extends \advanced_testcase {
    ...
    public function test_data_entries_document() {
        ...
        $this->assertEquals($data1doc->get('description2'), 'opt1 opt2 opt3 opt4 multimenu1 multimenu2 multimenu3 multimenu4 text area testing https://example.url');
        ...
        $this->assertEquals($data2doc->get('description2'), 'text area testing https://example.url');
        ...
        $this->assertEquals($data5doc->get('title'), 'https://example.url');
        ...
        $this->assertEquals($data8doc->get('content'), 'https://example.url');
        $this->assertEquals($data8doc->get('description1'), 'https://example.url');
        $this->assertEquals($data8doc->get('description2'), 'https://example.url');
