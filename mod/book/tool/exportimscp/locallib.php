 ...
 * @copyright  2001-3001 Antonio Vicent          {@link https://ludens.es}
 * @copyright  2001-3001 Eloy Lafuente (stronk7) {@link https://stronk7.com}
...
<!-- This package has been created with Moodle ' . $moodle_release . ' (' . $moodle_version . ') https://moodle.org/, Book module version ' . $book_version . ' - https://github.com/skodak/moodle-mod_book -->
<!-- One idea and implementation by Eloy Lafuente (stronk7) and Antonio Vicent (C) 2001-3001 -->
<manifest xmlns="https://www.imsglobal.org/xsd/imscp_v1p1" xmlns:imsmd="https://www.imsglobal.org/xsd/imsmd_v1p2" xmlns:xsi="https://www.w3.org/2001/XMLSchema-instance" identifier="MANIFEST-' . md5($CFG->wwwroot . '-' . $book->course . '-' . $book->id) . '" xsi:schemaLocation="https://www.imsglobal.org/xsd/imscp_v1p1 imscp_v1p1.xsd https://www.imsglobal.org/xsd/imsmd_v1p2 imsmd_v1p2p2.xsd">
...
function booktool_exportimscp_chapter_content($chapter, $context) {
    ...
    $content = '';
    $content .= '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "https://www.w3.org/TR/html4/loose.dtd">' . "\n";
    $content .= '<html>' . "\n";
    $content .= '<head>' . "\n";
