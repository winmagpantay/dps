...
/**
 * The mod_trainingevent company attendance withdrawn event.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attendance_withdrawn extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('attendance_withdrawn', 'mod_trainingevent');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' withdrew their request to trainingevent id  '$this->objectid' in " .
            $this->courseid;
    }
