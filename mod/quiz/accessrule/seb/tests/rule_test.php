...
class rule_test extends \advanced_testcase {
    ...
    public function valid_form_data_provider() : array {
        return [
            ...
            'valid seb_linkquitseb0' => ['seb_linkquitseb', 'https://safeexambrowser.org/macosx'],
            ...
            'valid seb_linkquitseb4' => ['seb_linkquitseb', 'https://any.type.of.url.looking.thing'],
        ];
    }
    ...
    public function test_get_quit_button() {
        $this->setAdminUser();
        $this->quiz = $this->create_test_quiz($this->course, settings_provider::USE_SEB_CLIENT_CONFIG);
        $this->quiz->seb_linkquitseb = "https://test.quit.link";
        ...
        $this->assertStringContainsString("https://test.quit.link", $button);
    }
    ...
    public function test_description() {
        ...
        $this->assertStringContainsString("https://test.quit.link", $description[1]);
    }
