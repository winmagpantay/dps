...
EOD;
        ...
        foreach ($users as $usersessionid => $userid) {
            ...
            echo '<a target="empty" href="https://'.$CFG->chat_serverhost.':'.$CFG->chat_serverport.
        ...
        switch($type) {
            ...
            case CHAT_SIDEKICK_USERS:
                ...
                $header .= "Refresh: ".(intval($CFG->chat_refresh_userlist) + 2).
                           "; url=https://$CFG->chat_serverhost:$CFG->chat_serverport/?win=users&".
                           "chat_sid=".$sessionid."\n";
                $header .= "\n";
    ...
    public function init_sockets() {
        ...
        // What exactly does this do? https://www.unixguide.net/network/socketfaq/4.5.shtml is still not enlightening enough for me.
