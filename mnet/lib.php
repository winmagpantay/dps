 ...
 *                       including its https:// prefix like
 ...
 *
 * See the {@Link https://www.w3.org/TR/xmldsig-core/ XML-DSig spec} at the W3c
 * site
 *
...
function mnet_sign_message($message, $privatekey = null) {
    ...
    <signedMessage>
        <Signature Id="MoodleSignature" xmlns="https://www.w3.org/2000/09/xmldsig#">
            <SignedInfo>
 ...
 * uniquely identify the RPC document as having come from this server.
 *
 * See the {@Link https://www.w3.org/TR/xmlenc-core/ XML-ENC spec} at the W3c
 * site
 *
 * @param  string   $message              The data you want to sign
...
function mnet_encrypt_message($message, $remote_certificate) {
    ...
    $message = '<?xml version="1.0" encoding="iso-8859-1"?>
    <encryptedMessage>
        <EncryptedData Id="ED" xmlns="https://www.w3.org/2001/04/xmlenc#">
            <EncryptionMethod Algorithm="https://www.w3.org/2001/04/xmlenc#arcfour"/>
            <ds:KeyInfo xmlns:ds="https://www.w3.org/2000/09/xmldsig#">
                <ds:RetrievalMethod URI="#EK" Type="https://www.w3.org/2001/04/xmlenc#EncryptedKey"/>
        ...
        <EncryptedKey Id="EK" xmlns="https://www.w3.org/2001/04/xmlenc#">
