...
class export_test extends \advanced_testcase {
    ...
    public function test_format_feedback_with_grade() {
        ...
        $tests = [
            ...
            'Multiple videos (HTML)' => [
                ...
                '<video src="https://example.com/myimage.jpg">video of a cat</video> for <em>reference</em></p>',
                FORMAT_HTML,
    ...
    public function format_feedback_provider() : array {
        return [
            ...
            'Has image (HTML)' => [
                '<p>See this reference: <img src="https://example.com/myimage.jpg"></p>',
                FORMAT_HTML,
                'See this reference: ',
            ],
            'Has image and more (HTML)' => [
                '<p>See <img src="https://example.com/myimage.jpg"> for <em>reference</em></p>',
                FORMAT_HTML,
                'See  for reference',
            ],
            'Has video and more (HTML)' => [
                '<p>See <video src="https://example.com/myimage.jpg">video of a duck</video> for <em>reference</em></p>',
                FORMAT_HTML,
                'See video of a duck for reference',
            ],
            'Multiple videos (HTML)' => [
                '<p>See <video src="https://example.com/myimage.jpg">video of a duck</video> and '.
                '<video src="https://example.com/myimage.jpg">video of a cat</video> for <em>reference</em></p>',
                FORMAT_HTML,
                'See video of a duck and video of a cat for reference'
            ],
