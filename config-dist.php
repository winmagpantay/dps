...
// https://docs.moodle.org/en/masquerading
...
// See details at: https://php.net/manual/en/function.date-default-timezone-set.php
// List of time zones at: https://php.net/manual/en/timezones.php
...
//     $CFG->xsendfile = 'X-LIGHTTPD-send-file'; // Lighttpd {@see https://redmine.lighttpd.net/projects/lighttpd/wiki/X-LIGHTTPD-send-file}
//     $CFG->xsendfile = 'X-Accel-Redirect';     // Nginx {@see https://wiki.nginx.org/XSendfile}
...
// Some examples are:
//      https://my.moodle.site/course/view.php
//      https://my.moodle.site/index.php
//      https://my.moodle.site/admin            (index.php implied)
...
//   https://yuilibrary.com/yui/docs/api/classes/config.html#property_logInclude
//   https://yuilibrary.com/yui/docs/api/classes/config.html#property_logExclude
...
// For details see the upstream documentation:
//   https://yuilibrary.com/yui/docs/api/classes/config.html#property_logLevel
...
//
// $CFG->behat_wwwroot = 'https://127.0.0.1/moodle';
...
// params hierarchy. More info: https://docs.behat.org/guides/7.config.html
// Example:
...
//         'wd_host' => 'https://127.0.0.1:4443/wd/hub',
//         'capabilities' => array(
//             'platform' => 'Linux',
//             'version' => 2.1
//         )
...
//           'behat_wwwroot' => 'https://127.0.0.1/moodle',
