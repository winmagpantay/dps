...
class restore_structure_parser_processor_test extends advanced_testcase {
    ...
    public function process_cdata_data_provider() {
        return array(
            ...
            array(
                "https://test.test/$@SLASH@$",
                "https://test.test/$@SLASH@$",
                true
            ),
            array(
                "<a href='$@FILEPHP@$1.jpg'>Image</a>",
                "<a href='https://test.test/file.php/11.jpg'>Image</a>",
                true
            ),
            array(
                "<a href='$@FILEPHP@$$@SLASH@$1.jpg'>Image</a>",
                "<a href='https://test.test/file.php/1/1.jpg'>Image</a>",
                true
            ),
            array(
            ...
            array(
                "<a href='$@FILEPHP@$1.jpg'>Image</a>",
                "<a href='https://test.test/file.php?file=%2F11.jpg'>Image</a>",
                false
            ),
            array(
                "<a href='$@FILEPHP@$$@SLASH@$1.jpg'>Image</a>",
                "<a href='https://test.test/file.php?file=%2F1%2F1.jpg'>Image</a>",
                false
            ),
            array(
                "<a href='$@FILEPHP@$$@SLASH@$$@SLASH@$1.jpg'>Image</a>",
                "<a href='https://test.test/file.php?file=%2F1%2F%2F1.jpg'>Image</a>",
                false
            ),
            array(
                "<a href='$@FILEPHP@$$@SLASH@$1.jpg$@FORCEDOWNLOAD@$'>Image</a>",
                "<a href='https://test.test/file.php/1/1.jpg?forcedownload=1'>Image</a>",
                true
            ),
            array(
                "<a href='$@FILEPHP@$$@SLASH@$1.jpg$@FORCEDOWNLOAD@$'>Image</a>",
                "<a href='https://test.test/file.php?file=%2F1%2F1.jpg&amp;forcedownload=1'>Image</a>",
                false
            ),
            array(
                "<iframe src='$@H5PEMBED@$?url=testurl'></iframe>",
                "<iframe src='https://test.test/h5p/embed.php?url=testurl'></iframe>",
                true
            ),
        );
    }
