...
class page11_resurce_file extends general_cc_file {
    ...
    protected $ccnamespaces = array('xmlns' => 'https://www.w3.org/1999/xhtml');
    ...
    public function on_save() {
        ...
        $this->append_new_attribute_ns($head, $rns, 'profile', 'https://dublincore.org/documents/dc-html/');
        ...
        $this->append_new_attribute_ns($link_dc, $rns, 'href', 'https://purl.org/dc/elements/1.1/');
        $link_dcterms = $this->append_new_element_ns($head, $rns, 'link');
        $this->append_new_attribute_ns($link_dcterms, $rns, 'rel', 'schema.DCTERMS');
        $this->append_new_attribute_ns($link_dcterms, $rns, 'href', 'https://purl.org/dc/terms/');
        // Content type.
