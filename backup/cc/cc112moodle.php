...
class cc112moodle extends cc2moodle {
    ...
    public static $namespaces = array('imscc'    => 'https://www.imsglobal.org/xsd/imsccv1p1/imscp_v1p1',
                                      'lomimscc' => 'https://ltsc.ieee.org/xsd/imsccv1p1/LOM/manifest',
                                      'lom'      => 'https://ltsc.ieee.org/xsd/imsccv1p1/LOM/resource',
                                      'xsi'      => 'https://www.w3.org/2001/XMLSchema-instance',
                                      'cc'       => 'https://www.imsglobal.org/xsd/imsccv1p1/imsccauth_v1p1');

    public static $restypes = array('associatedcontent/imscc_xmlv1p1/learning-application-resource', 'webcontent');
    public static $forumns  = array('dt' => 'https://www.imsglobal.org/xsd/imsccv1p1/imsdt_v1p1');
    public static $quizns   = array('xmlns' => 'https://www.imsglobal.org/xsd/ims_qtiasiv1p2');
    public static $resourcens = array('wl' => 'https://www.imsglobal.org/xsd/imsccv1p1/imswl_v1p1');
    public static $basicltins = array(
                                       'xmlns' => 'https://www.imsglobal.org/xsd/imslticc_v1p0',
                                       'blti'  => 'https://www.imsglobal.org/xsd/imsbasiclti_v1p0',
                                       'lticm' => 'https://www.imsglobal.org/xsd/imslticm_v1p0',
                                       'lticp' => 'https://www.imsglobal.org/xsd/imslticp_v1p0'
                                      );
