...
class filter_urltolink extends moodle_text_filter {
    ...
    protected function convert_urls_into_links(&$text) {
        ...
        // Original RFC regex from: https://www.bytemycode.com/snippets/snippet/796/
        // Various ideas from: https://alanstorm.com/url_regex_explained
        ...
        // Is not HTML attribute or CSS URL property. Unfortunately legit text like "url(https://...)" will not be a link.
        $lookbehindend = "(?<![]),.;])";
