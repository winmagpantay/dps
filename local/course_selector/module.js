...
M.local_course_selector = M.local_course_selector || {};
// Define a course selectors array for against the cure_course namespace
M.local_course_selector.course_selectors = [];
/**
 ...
 * @return bool
 */
M.local_course_selector.get_course_selector = function (name) {
 ...
 */
M.local_course_selector.init_course_selector = function (Y, name, hash, extrafields, lastsearch) {
    ...
    var course_selector = {
        ...
        output_options : function(data) {
            ...
            if (!count) {
                var searchstr = (this.lastsearch != '')?this.insert_search_into_str(M.str.local_course_selector.nomatchingcourses, this.lastsearch):M.str.moodle.none;
            ...
            if (this.get_option('preserveselected') && selectedcourses) {
                this.output_group(this.insert_search_into_str(M.str.local_course_selector.previouslyselectedcourses, this.lastsearch), selectedcourses, true, false);
            }
 ...
 */
M.local_course_selector.init_course_selector_options_tracker = function(Y) {
