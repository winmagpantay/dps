...
* Follows the [PSR-4 and PSR-7 standards](https://php-fig.org).
...
* **For more details about what has changed, see the
  [Migration Guide](https://docs.aws.amazon.com/aws-sdk-php/v3/guide/guide/migration.html)**.
...
* `Aws\S3` - Added support for ["Requester Pays" buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html).
...
* Added support for the [Desired Partition Count scaling
  option](https://aws.amazon.com/releasenotes/2440176739861815) to the
...
* [BC] Updated the Amazon CloudSearch client to use the new 2013-01-01 API version (see [their release
  notes](https://aws.amazon.com/releasenotes/6125075708216342)). This API version of CloudSearch is significantly
...
* Added support for [resize progress data and the Cluster Revision Number
  parameter](https://aws.amazon.com/releasenotes/0485739709714318) to the Amazon Redshift client.
* Added the `ap-northeast-1`, `ap-southeast-2`, and `sa-east-1` regions to the Amazon CloudSearch client.

## 2.5.4 - 2014-03-20

* Added support for [access logs](https://docs.aws.amazon.com/ElasticLoadBalancing/latest/DeveloperGuide/access-log-collection.html)
...
* Updated the Amazon CloudFront client to use the 2014-01-31 API version. See [their release
  notes](https://aws.amazon.com/releasenotes/1900016175520505).
...
* Added support for the new **China (Beijing) Region** to various services. This region is currently in limited preview.
  Please see <https://www.amazonaws.cn> for more information
...
* Added support for [geo restriction](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/WorkingWithDownloadDistributions.html#georestrictions)
...
* Added a new [Zip Download](https://pear.amazonwebservices.com/get/aws.zip) for installing the SDK
