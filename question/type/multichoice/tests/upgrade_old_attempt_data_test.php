...
class upgrade_old_attempt_data_test extends \question_attempt_upgrader_test_base {
    ...
    public function test_multichoice_deferredfeedback_history60() {
        ...
        $question = (object) array(
            ...
            'questiontext' => '<p>I have demonstrated the ability to analyse and <strong>answer the question</strong> that is asked. (<a title="Advice" href="https://learnacct.open.ac.uk/mod/resourcepage/view.php?id=5989">Click for advice on this skill</a>)',
            'questiontextformat' => '1',
            'defaultmark' => '1',
            'penalty' => '0',
            'qtype' => 'multichoice',
...
public function test_multichoice_deferredfeedback_qsession140() {
    ...
    public function test_multichoice_deferredfeedback_qsession2018195() {
        ...
        <p>We would welcome your input (allow 10-15 minutes). The data you provide will be anonymised and used for research purposes only. This project is administered under the OU’s general data protection policy guidelines, which can be seen here: <a href="https://www3.open.ac.uk/our-student-policies/pdf/dataprotection.pdf">https://www3.open.ac.uk/our-student-policies/pdf/dataprotection.pdf</a></p>',
            'introformat' => FORMAT_HTML,
            'questiondecimalpoints' => '-1',
            'showuserpicture' => '1',
            'showblocks' => '1',
            ...
            'options' => (object) array(
                ...
                'answers' => array(
                    ...
                    667 => (object) array(
                        'question' => '247',
                        'answer' => 'Not sure',
                        'feedback' => 'We recommend that you visit the OU Library\'s information page on <a href="https://library.open.ac.uk/libraries/update/access_computers.html" target="blank"><b>Using public access computers in libraries and other venues</b></a>.',
                        'fraction' => '1',
                        'id' => 667,
                    ),
                    668 => (object) array(
            ...
            'options' => (object) array(
                ...
                'answers' => array(
                    651 => (object) array(
                        'question' => '242',
                        'answer' => 'Well developed',
                        'feedback' => 'You obviously feel confident about using the internet in order to manage your documentation and find information on the World Wide Web. However, you may still find the OU\'s <a href="https://www.open.ac.uk/webguide/" target="blank"><b>Web Guide</b></a> site of interest.',
                        'fraction' => '1',
                        'id' => 651,
                    ),
                    652 => (object) array(
                        'question' => '242',
                        'answer' => 'Not sure',
                        'feedback' => 'We recommend that you visit the OU\'s <a href="https://www.open.ac.uk/webguide/" target="blank"><b>Web Guide</b></a> site and work through some of the tips and advice about using the web effectively.',
                        'fraction' => '1',
                        'id' => 652,
                    ),
                    653 => (object) array(
