...
class question_definition_test extends \advanced_testcase {
    public function test_make_html_inline() {
        ...
        $this->assertEquals('<img src="https://example.com/pic.png" alt="Graph" />',
                $mc->make_html_inline(
                    '<p><img src="https://example.com/pic.png" alt="Graph" /></p>'));
        $this->assertEquals("Frog<br />XXX <img src='https://example.com/pic.png' alt='Graph' />",
                $mc->make_html_inline(" <p> Frog </p> \n\r
                    <p> XXX <img src='https://example.com/pic.png' alt='Graph' /> </p> "));
