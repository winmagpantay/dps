...
class auth_iomadsaml2_metadata_refresh_testcase extends advanced_testcase {
    ...
    public function test_metadata_refresh_disabled() {
        ...
        set_config('idpmetadata', 'https://somefakeidpurl.local', 'auth_iomadsaml2');
...
XML;
    ...
    public function test_metadata_refresh_fetch_fails() {
        ...
        $fetcher->fetch('https://somefakeidpurl.local')->willThrow(new \moodle_exception('metadatafetchfailed', 'auth_iomadsaml2'));
        $refreshtask->execute();
    }
    ...
    public function test_metadata_refresh_parse_fails() {
        ...
        $fetcher->fetch('https://somefakeidpurl.local')->willReturn('doesnotmatter');
    ...
    public function test_metadata_refresh_parse_no_idpname() {
        ...
        $this->assertEquals(get_string('idpnamedefault', 'auth_iomadsaml2'), $idpmduinames['https://somefakeidpurl.local']);
    }
    ...
    public function test_metadata_refresh_write_fails() {
        ...
        $fetcher->fetch('https://somefakeidpurl.local')->willReturn('somexml');
