 ...
 * @copyright   2018 Catalyst IT Australia {@link https://www.catalyst-au.net}
...
class setting_idpmetadata_test extends advanced_testcase {
    ...
    public function test_it_returns_error_if_metadata_url_is_not_valid() {
        ...
        if (method_exists($this, 'assertStringContainsString')) {
            ...
            self::assertStringContainsString('https://invalid.url.metadata.test', $error);
        } else {
            ...
            self::assertContains('https://invalid.url.metadata.test', $error);
