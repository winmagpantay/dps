...
* IdP initiated flow / IdP first flow / IdP unsolicited logins, eg:
  https://idp.local/simplesaml/iomadsaml2/idp/SSOService.php?spentityid=https://moodle.local/auth/iomadsaml2/sp/metadata.php&RelayState=https://moodle.local/course/view.php?id=2
