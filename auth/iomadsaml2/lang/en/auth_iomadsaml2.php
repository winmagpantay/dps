...
$string['attrsimple_help'] = 'Various IdP\'s such as ADFS use long attribute keys such as urns or namespaced xml schema names. If set to Yes this will simplify these, eg map https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname to such \'givenname\'.';
...
$string['idpmetadata_help'] = 'To use multiple IdPs enter each public metadata url on a new line.<br/>To override a name, place text before the http. eg. "Forced IdP Name https://ssp.local/simplesaml/iomadsaml2/idp/metadata.php"';
