...
abstract class ssl_algorithms {
    ...
    public static function get_default_saml_signature_algorithm() {
        ...
        return 'https://www.w3.org/2001/04/xmldsig-more#rsa-sha256';
    }
    ...
    public static function get_valid_saml_signature_algorithms() {
        $return = array();
        $return['https://www.w3.org/2001/04/xmldsig-more#rsa-sha256'] = get_string('sha256', 'auth_iomadsaml2');
        $return['https://www.w3.org/2001/04/xmldsig-more#rsa-sha384'] = get_string('sha384', 'auth_iomadsaml2');
        $return['https://www.w3.org/2001/04/xmldsig-more#rsa-sha512'] = get_string('sha512', 'auth_iomadsaml2');
        $return['https://www.w3.org/2000/09/xmldsig#rsa-sha1'] = get_string('sha1', 'auth_iomadsaml2');
        return $return;
    }
    ...
    public static function convert_signature_algorithm_to_digest_alg_format($signaturealgorithm) {
        switch($signaturealgorithm) {
            case 'https://www.w3.org/2001/04/xmldsig-more#rsa-sha256':
                return 'SHA256';
            case 'https://www.w3.org/2001/04/xmldsig-more#rsa-sha384':
                return 'SHA384';
            case 'https://www.w3.org/2001/04/xmldsig-more#rsa-sha512':
                return 'SHA512';
            case 'https://www.w3.org/2000/09/xmldsig#rsa-sha1':
                return 'SHA1';
        }
