...
class SAML2Test extends ClearStateTestCase
{
    ...
    public function testIdPInitiatedLoginMinimumParams(): void
    {
        ...
        $this->assertStringStartsWith(
            'https://idp.examlple.com/saml2/idp/SSOService.php?spentityid=https%3A%2F%2Fsome-sp-entity-id&cookie',
    ...
    public function testIdPInitiatedLoginOptionalParams(): void
    {
        ...
        $this->assertStringStartsWith(
            'https://idp.examlple.com/saml2/idp/SSOService.php?'
        ...
        $expectedState['saml:RelayState'] = 'https://relay';
