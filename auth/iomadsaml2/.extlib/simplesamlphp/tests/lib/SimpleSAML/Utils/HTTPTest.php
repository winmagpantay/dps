...
class HTTPTest extends ClearStateTestCase
{
    ...
    public function testGetSelfURLMethods(): void
    {
        ...
        $this->setupEnvFromURL('https://www.example.com/protected/resource.asp?foo=bar');
        $this->assertEquals('https://www.example.com/protected/resource.asp?foo=bar', HTTP::getSelfURL());
        $this->assertEquals('https://www.example.com', HTTP::getSelfURLHost());
        $this->assertEquals('https://www.example.com/protected/resource.asp', HTTP::getSelfURLNoQuery());
        ...
        $this->setupEnvFromURL('https://www.example.org/module.php/module/file.php?foo=bar');
        $this->assertEquals(
        ...
        $this->setupEnvFromURL('https://www.example.org/simplesaml/module.php/module/file.php?foo=bar');
        $this->assertEquals(
            'https://www.example.org/simplesaml/module.php/module/file.php?foo=bar',
            HTTP::getSelfURL()
        );
        $this->assertEquals('https://www.example.org', HTTP::getSelfURLHost());
        $this->assertEquals('https://www.example.org/simplesaml/module.php/module/file.php', HTTP::getSelfURLNoQuery());
        $this->assertFalse(HTTP::isHTTPS());
        $this->assertEquals('https://' . HTTP::getSelfHostWithNonStandardPort(), HTTP::getSelfURLHost());
