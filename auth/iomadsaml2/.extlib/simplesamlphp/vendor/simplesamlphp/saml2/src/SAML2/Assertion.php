...
class Assertion extends SignedElement
{
     ...
     *
     * See:
     * @url https://docs.oasis-open.org/security/saml/v2.0/saml-authn-context-2.0-os.pdf
     *
    ...
    /**
     * The attributes values types as per https://www.w3.org/2001/XMLSchema definitions
    ...
    private function addEncryptedAttributeStatement(DOMElement $root) : void
    {
        ...
        foreach ($this->attributes as $name => $values) {
            ...
            $EncAssert->type = 'https://www.w3.org/2001/04/xmlenc#Element';
            /*
