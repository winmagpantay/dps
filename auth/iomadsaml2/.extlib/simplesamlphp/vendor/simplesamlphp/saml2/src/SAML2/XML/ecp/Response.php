...
class Response
{
    ...
    public function __construct(DOMElement $xml = null)
    {
        ...
        if ($xml->getAttributeNS(Constants::NS_SOAP, 'actor') !== 'https://schemas.xmlsoap.org/soap/actor/next') {
...
-     */
    ...
    public function toXML(DOMElement $parent) : DOMElement
    {
        ...
        $response->setAttributeNS(Constants::NS_SOAP, 'SOAP-ENV:actor', 'https://schemas.xmlsoap.org/soap/actor/next');
