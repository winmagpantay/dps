...
{
    public const NS = 'https://symfony.com/schema/dic/services';
    ...
    {
        $schemaLocations = ['https://symfony.com/schema/dic/services' => str_replace('\\', '/', __DIR__.'/schema/dic/services/services-1.0.xsd')];

        if ($element = $dom->documentElement->getAttributeNS('https://www.w3.org/2001/XMLSchema-instance', 'schemaLocation')) {
            ...
            for ($i = 0, $nb = \count($items); $i < $nb; $i += 2) {
                ...
                if (($extension = $this->container->getExtension($items[$i])) && false !== $extension->getXsdValidationBasePath()) {
                    ...
                    $path = str_replace([$ns, str_replace('https://', 'https://', $ns)], str_replace('\\', '/', $extension->getXsdValidationBasePath()).'/', $items[$i + 1]);
