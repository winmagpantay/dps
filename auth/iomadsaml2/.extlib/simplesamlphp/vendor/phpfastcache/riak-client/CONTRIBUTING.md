...
* [PHP / Pear Docblock Guide](https://pear.php.net/manual/en/standards.sample.php)
...
You can [read the full guidelines for bug reporting and code contributions](https://docs.basho.com/riak/latest/community/bugs/) on the Riak Docs. 
