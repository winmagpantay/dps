...
<Location />
    ...
    #
    # The syntax for this option is inherited from: https://docs.libmemcached.org/libmemcached_configuration.html 
...
<Location /protected>
    ...
    # please look at:
    # https://httpd.apache.org/docs/2.0/mod/core.html#require
    Require valid-user
</Location>
```
