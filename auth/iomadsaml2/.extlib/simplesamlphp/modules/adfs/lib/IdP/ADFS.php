...
class ADFS
{
    ...
    private static function generateResponse($issuer, $target, $nameid, $attributes, $assertionLifetime)
    {
        ...
        $nameidFormat = 'https://schemas.xmlsoap.org/claims/UPN';
...
MSG;
   ...
   <wsp:AppliesTo xmlns:wsp="https://schemas.xmlsoap.org/ws/2004/09/policy">
       <wsa:EndpointReference xmlns:wsa="https://schemas.xmlsoap.org/ws/2004/08/addressing">
...
MSG;
    ...
    private static function signResponse($response, $key, $cert, $algo, $passphrase)
    {
        ...
        $objXMLSecDSig->addReferenceList(
            ...
            ['https://www.w3.org/2000/09/xmldsig#enveloped-signature', XMLSecurityDSig::EXC_C14N],
            ['id_name' => 'AssertionID']
        );
