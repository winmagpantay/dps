...
$config = [
     ...
     *
     * See this page for a list of valid timezones: https://php.net/manual/en/timezones.php
     */
    'timezone' => null,
     ...
     * https://idp.example.org/ssp/module.php/core/postredirect.php must be accessible.
     */
     ...
     *
     * See the documentation for openlog (https://php.net/manual/en/function.openlog.php) for available
     ...
     *    group. https://php.net/manual/en/function.Memcache-addServer.php
     ...
     *      [
     *          'type' => 'mdq',
     *          'server' => 'https://mdq.server.com:8080',
     ...
     *
     * See https://www.php.net/manual/en/pdo.drivers.php for the various
     * syntaxes.
     */
