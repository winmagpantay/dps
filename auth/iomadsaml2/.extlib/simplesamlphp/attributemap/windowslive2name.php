...
$attributemap = [
    ...
    'windowslive_targetedID' => 'eduPersonTargetedID', // https://windowslive.com!uid
    ...
    // Attributes returned by Microsoft Graph - https://graph.microsoft.io/en-us/docs/api-reference/v1.0/resources/user
