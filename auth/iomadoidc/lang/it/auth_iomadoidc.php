...
$string['cfg_iomadoidcscope_key'] = 'Scopo';
$string['cfg_iomadoidcscope_desc'] = 'L\'ambito IOMAD OIDC da utilizzare.';
...
$string['erroriomadoidcclientinvalidendpoint'] = 'Ricevuto URI endpoint non valido.';
$string['erroriomadoidcclientnocreds'] = 'Impostare credenziali cliente con segreti';
$string['erroriomadoidcclientnoauthendpoint'] = 'Nessun endpoint di autorizzazione impostato. Impostarlo con $this->setendpoints';
$string['erroriomadoidcclientnotokenendpoint'] = 'Nessun endpoint token impostato. Impostare con $this->setendpoints';
$string['erroriomadoidcclientinsecuretokenendpoint'] = 'L\'endpoint token deve utilizzare SSL/TLS.';
$string['errorucpinvalidaction'] = 'Ricevuta azione non valida.';
$string['erroriomadoidccall'] = 'Si è verificato un errore in OpenID Connect. Consultare i log per ulteriori informazioni.';
$string['erroriomadoidccall_message'] = 'Si è verificato un errore in OpenID Connect: {$a}';
...
$string['iomadoidc:manageconnection'] = 'Gestisci connessione OpenID Connect';
