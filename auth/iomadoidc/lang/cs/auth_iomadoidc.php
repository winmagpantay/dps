...
$string['cfg_iomadoidcscope_desc'] = 'Rozsah IOMAD OIDC, který se má použít.';
...
$string['erroriomadoidcclientnoauthendpoint'] = 'Není nastaven žádný koncový bod autorizace. Nastavte pomocí $this->setendpoints';
