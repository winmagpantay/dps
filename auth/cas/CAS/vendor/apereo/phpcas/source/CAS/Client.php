...
class CAS_Client
{
        ...
        if (preg_match('/^PGTIOU-[\.\-\w]+$/', $pgtIou)) {
            if (preg_match('/^[PT]GT-[\.\-\w]+$/', $pgtId)) {
                ...
                if ($this->isXmlResponse()) {
                    ...
                    echo '<proxySuccess xmlns="https://www.yale.edu/tp/cas" />';
    ...
    */
    ...
    private function _readURL($url, &$headers, &$body, &$err_msg)
    {
        ...
        if ($this->getServerVersion() == SAML_VERSION_1_1) {
            $request->addHeader("soapaction: https://www.oasis-open.org/committees/security");
    ...
    */
     ...
     *  https://jasig.275507.n4.nabble.com/CAS-attributes-and-how-they-appear-in-the-CAS-response-td264272.html
    ...
    */
     ...
     *
     * @link https://stackoverflow.com/questions/1842681/regular-expression-to-remove-one-parameter-from-query-string
     */
