...
// See https://support.microsoft.com/kb/305144 to interprete these values.
    ...
    function user_create($userobject, $plainpass) {
        ...
        switch ($this->config->user_type)  {
            ...
            case 'ad':
                ...
                // double quotes. See https://support.microsoft.com/?kbid=269190
...
/// User Additions
    ...
    function ldap_get_ad_pwdexpire($pwdlastset, $ldapconn, $user_dn){
        ...
        // https://msdn2.microsoft.com/en-us/library/ms974598.aspx)
        //
