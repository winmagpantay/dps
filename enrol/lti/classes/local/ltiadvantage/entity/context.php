 ...
 *
 * See: https://www.imsglobal.org/spec/lti/v1p3/#context-type-vocabulary for supported context types.
 *
 * @package    enrol_lti
...
class context {
    ...
    private const CONTEXT_TYPE_COURSE_TEMPLATE = 'https://purl.imsglobal.org/vocab/lis/v2/course#CourseTemplate';

    /** @var string course offering context */
    private const CONTEXT_TYPE_COURSE_OFFERING = 'https://purl.imsglobal.org/vocab/lis/v2/course#CourseOffering';

    /** @var string course section context */
    private const CONTEXT_TYPE_COURSE_SECTION = 'https://purl.imsglobal.org/vocab/lis/v2/course#CourseSection';

    /** @var string group context */
    private const CONTEXT_TYPE_GROUP = 'https://purl.imsglobal.org/vocab/lis/v2/course#Group';
