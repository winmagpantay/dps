 ...
 *
 * See https://www.imsglobal.org/spec/lti/v1p3/#launch-from-a-resource-link
 *
 * @package enrol_lti
...
class tool_launch_service {
    ...
    private function user_is_admin(\stdClass $launchdata): bool {
        ...
        if ($launchdata->roles) {
            $adminroles = [
                'https://purl.imsglobal.org/vocab/lis/v2/institution/person#Administrator',
                'https://purl.imsglobal.org/vocab/lis/v2/system/person#Administrator'
            ];
    ...
    private function user_is_staff(\stdClass $launchdata, bool $includelegacy = false): bool {
        ...
        if ($launchdata->roles) {
            $staffroles = [
                'https://purl.imsglobal.org/vocab/lis/v2/membership#ContentDeveloper',
                'https://purl.imsglobal.org/vocab/lis/v2/membership#Instructor',
                'https://purl.imsglobal.org/vocab/lis/v2/membership/Instructor#TeachingAssistant'
            ];
