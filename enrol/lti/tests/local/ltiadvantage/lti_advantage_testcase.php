...
abstract class lti_advantage_testcase extends \advanced_testcase {
    ...
    protected function get_mock_launch_users_with_ids(array $ids, bool $includepicture = false,
            string $role = 'https://purl.imsglobal.org/vocab/lis/v2/membership#Instructor'): array {
                ...
                use ($resource, $mockuser, $resourcelinkid, $migrationclaiminfo, $ags, $nrps, $customparams, $aud) {
                    ...
                    $data = [
                        ...
                        'https://purl.imsglobal.org/spec/lti/claim/roles' =>
                            $mockuser['roles'] ?? ['https://purl.imsglobal.org/vocab/lis/v2/membership#Instructor'],
                        ...
                        "https://purl.imsglobal.org/spec/lti/claim/context" => [
                            ...
                            "type" => ["https://purl.imsglobal.org/vocab/lis/v2/course#CourseOffering"]
                        ],
