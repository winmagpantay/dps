        ...
        return [
            'Creation of a course section context' => [
                'args' => [
                    ...
                    'types' => [
                        'https://purl.imsglobal.org/vocab/lis/v2/course#CourseSection'
                    ],
                    'id' => null
                ],
                'expectations' => [
            ...
            'Creation of a course offering context' => [
                'args' => [
                    ...
                    'contextid' => 'context-123',
                    'types' => [
                        'https://purl.imsglobal.org/vocab/lis/v2/course#CourseOffering'
                    ],
                    'id' => null
                ],
                'expectations' => [
            ...
            'Creation of a course template context' => [
                'args' => [
                    ...
                    'contextid' => 'context-123',
                    'types' => [
                        'https://purl.imsglobal.org/vocab/lis/v2/course#CourseTemplate'
                    ],
                    'id' => null
                ],
                'expectations' => [
            ...
            'Creation of a course group context' => [
                'args' => [
                    ...
                    'contextid' => 'context-123',
                    'types' => [
                        'https://purl.imsglobal.org/vocab/lis/v2/course#Group'
                    ],
                    'id' => null
                ],
                'expectations' => [
            ...
            'Creation of an invalid context' => [
                ...
                'expectations' => [
                    ...
                    'exceptionmessage' => "Cannot set invalid context type 'https://example.com/invalid/context'."
                ]
            ],
