...
$string['welcomep50'] = 'Користењето на сите апликации во овој пакет се регулира со нејзините лиценци. Комплетниот <strong>{$a->installername}</strong> пакет е   <a href="https://www.opensource.org/docs/definition_plain.html">слободен софтвер</a> и е дистрибуиран под <a href="https://www.gnu.org/copyleft/gpl.html">GPL</a> лиценцата.';
