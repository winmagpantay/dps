...
<p>ສິ່ງນີ້ອາດເຮັດໃຫ້ Moodle ມີບັນຫາຄວາມຈຳໃນພາຍຫຼັງ, ໂດຍສະເພາະ
...
<li>ຖ້າທ່ານສາມາດ, ລວບລວມ PHP ຄືນໃໝ່ດ້ວຍ <i>--enable-memory-limit</i>.
    ສິ່ງນີ້ຈະເຮັດໃຫ້ Moodle ສາມາດຕັ້ງຂີດຈຳກັດຄວາມຈຳໄດ້ເອງ.</li>
...
<li>ໃນບາງເຊີບເວີ PHP ທ່ານສາມາດສ້າງໄຟລ໌ .htaccess ໃນໄດເລກະທໍລີ Moodle
    ປະກອບມີເສັ້ນນີ້:
...
$string['phpversionhelp'] = '<p>Moodle ຕ້ອງການສະບັບ PHP ຢ່າງໜ້ອຍ 5.6.5 ຫຼື 7.1 (7.0.x ມີການຈຳກັັດບາງເຄື່ອງຈັກ).</p>
