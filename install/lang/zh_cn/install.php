...
$string['welcomep50'] = '使用本软件包中包含的应用程序时应遵循它们各自的授权协议。整个<strong>{$a->installername}</strong>软件包都是<a href="https://www.opensource.org/docs/definition_plain.html">开源</a>的，并且遵循<a href="https://www.gnu.org/copyleft/gpl.html">GPL</a>授权协议发布。';
